...
if (isset($argv[1]))
{
	if ($argv[1] == 1)
	{
		$namefixer->fixNamesWithNames(1);
	}
	else if ($argv[1] == 2)
	{
		$namefixer->fixNamesWithNames(2);
	}
	else if ($argv[1] == 3)
	{
		$namefixer->fixNamesWithNfo(1);
	}
	else if ($argv[1] == 4)
	{
		$namefixer->fixNamesWithNfo(2);
	}
	else if ($argv[1] == 5)
	{
		$namefixer->fixNamesWithFiles(1);
	}
	else if ($argv[1] == 6)
	{
		$namefixer->fixNamesWithFiles(2);
	}
	else
	{
