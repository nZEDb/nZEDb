...
convertTable($pdo,
			 ...
			 "releases",
			 "INSERT INTO " . $nZEDB_schema .
			 ".releases (adddate, anidbid, bookinfoid, categories_id, comments, completion, consoleinfo_id, fromname, grabs, group_id, guid, haspreview, id, imdbid, musicinfo_id, name, passwordstatus, postdate, rarinnerfilecount, searchname, size, totalpart, nzb_guid) " .
