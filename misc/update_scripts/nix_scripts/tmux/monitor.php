...
$proc_work2 = "SELECT
	...
	( SELECT COUNT( r.id ) FROM releases r LEFT JOIN category c ON c.id = r.categoryid (r.passwordstatus between -6 AND -1) AND (r.haspreview = -1 AND c.disablepreview = 0) AND r.nzbstatus = 1 ) AS work,
