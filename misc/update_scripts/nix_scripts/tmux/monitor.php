...
while( $i > 0 )
{
	...
	if ( $i == 1 )
	{
		...
		if ( @$proc_work_result[0]['requestID_matched'] != NULL ) { $requestID_matched_start = $proc_work_result[0]['requestID_matched']; }
	}
	...
	$requestID_diff = number_format( $requestID_matched - $requestID_matched_start );
