...
if ( $seq == "TRUE" )
{
	...
	shell_exec("tmux selectp -t 0 && tmux splitw -h -p 67 'printf \"\033]2;sequential_run\033\"'");
	...
	shell_exec("tmux selectp -t 3 && tmux splitw -v -p 75 'printf \"\033]2;nzb-import-bulk\033\"'");
