...
function start_apps()
{
	...
	if (( $bwmng == "TRUE" ) && (!command_exist($bwmng)))
	{
...
if ( $seq == "TRUE" )
{
	...
	shell_exec("tmux new-window -n post 'printf \"\033]2;fixReleaseNames\033\"'");
	shell_exec("tmux splitw -v -p 50 'printf \"\033]2;postprocessing\033\"'");
