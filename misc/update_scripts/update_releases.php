...
else
{
	echo "ERROR: You must supply an argument.\n".
			"php update_releases.php 1 true ...: Attempts to categorize releases\n".
			"php update_releases.php 2 true ...: Leaves new releases in other -> misc\n".
