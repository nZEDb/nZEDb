...
You must first copy ircscraper_settings_example.php to ircscraper_settings.php and change the settings in the file (ircscraper_settings.php). (in /var/www/nZEDb/configuration)
