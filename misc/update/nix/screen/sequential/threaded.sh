...
#
#	Usage
#	   screen: Call this script directly within a screen session. Loops continously.
#	   tmux:   Copy this script to user_threaded.sh and change tmux setting to complete sequential.
#		   Any changes made are active upon next run.
#
#	In general its best to keep the loop times between 15 and 60 minutes.
