...
$proc_work3 = "SELECT "
	. "(SELECT COUNT(*) FROM releases WHERE nzbstatus = 1 AND (bitwise & 1028) = 1024 AND reqidstatus in (0, -1) OR (reqidstatus = -3 AND adddate > NOW() - INTERVAL " . $request_hours . " HOUR)) AS requestid_inprogress, "
