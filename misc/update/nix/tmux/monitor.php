...
$proc_work2 = "SELECT "
	...
	. "(SELECT COUNT(*) FROM releases r INNER JOIN category c ON c.id = r.categoryid WHERE r.nzbstatus = 1 AND ((r.passwordstatus BETWEEN -6 AND -1 AND r.haspreview = -1 AND c.disablepreview = 0) OR (r.categoryid = 4050 AND r.gamesinfo_id = 0) OR (r.categoryid BETWEEN 6000 AND 6040 AND r.xxxinfo_id = 0))) AS work, "
