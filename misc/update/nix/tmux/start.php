...
function window_proxy($tmux_session, $window)
{
	...
	if ($nntpproxy === '1' && ($pdo->getSetting('alternate_nntp') == '1')) {
		...
		if (file_exists($DIR . "update/python/lib/nntpproxy_a.conf")) {
			...
			exec("tmux selectp -t $tmux_session:0.0; tmux splitw -t $tmux_session:$window -h -p 50 'printf \"\033]2;NNTPProxy\033\" && python $nntpproxypy $nntpproxyconf'");
		}
	}
}
...
function window_utilities($tmux_session)
{
	...
	exec("tmux selectp -t $tmux_session:0.0; tmux splitw -t $tmux_session:1 -h -p 50 'printf \"\033]2;removeCrapReleases\033\"'");
	exec("tmux selectp -t $tmux_session:0.2; tmux splitw -t $tmux_session:1 -h -p 50 'printf \"\033]2;decryptHashes\033\"'");
}
...
function window_stripped_utilities($tmux_session)
{
	...
	exec("tmux selectp -t $tmux_session:0.0; tmux splitw -t $tmux_session:1 -h -p 50 'printf \"\033]2;postprocessing_amazon\033\"'");
}
