...
class MySql extends \lithium\data\source\database\adapter\MySql
{
	...
	public function timezone($value = null)
	{
		if ($value === null) {
			...
			$result = false;
			trigger_error(__CLASS__ . '::' . __METHOD__ . ":\n Empty value passed for timezone setting! Check date.timezone setting is set in PHP's configuration file(s).", E_USER_WARNING);
		} else {
