...
class Initial extends AbstractMigration
{
	...
	public function up()
    {
		...
		if (!$this->hasTable('binaryblacklist')) {
		...
		if (!$this->hasTable('category_regexes')) {
		...
		if (!$this->hasTable('collection_regexes')) {
		...
		if (!$this->hasTable('collections')) {
			$this->table('collections')
				...
				->addColumn('collection_regexes_id',
					'integer',
					[
		...
		if (!$this->hasTable('dnzb_failures')) {
			$this->table('dnzb_failures')
				->addColumn('release_id',
					'integer',
					[
						'default' => null,
						'limit'   => 11,
		...
		if (!$this->hasTable('groups')) {
			$this->table('groups')
				...
				->addColumn('first_record_postdate',
					'datetime',
					[
						'default' => null,
						'limit'   => null,
				...
				->addColumn('last_record_postdate',
					'datetime',
					[
						'default' => null,
						'limit'   => null,
				...
				->addColumn('minfilestoformrelease',
					'integer',
					[
						'default' => null,
						'limit'   => 4,
				...
				->addColumn('minsizetoformrelease',
					'biginteger',
					[
						'default' => null,
						'limit'   => 20,
		...
		if (!$this->hasTable('multigroup_binaries')) {
		...
		if (!$this->hasTable('multigroup_collections')) {
		...
		if (!$this->hasTable('multigroup_missed_parts')) {
		...
		if (!$this->hasTable('multigroup_parts')) {
			$this->table('multigroup_parts')
				->addColumn('binaries_id',
					'biginteger',
					[
						'default' => '0',
						'limit'   => 20,
		...
		if (!$this->hasTable('multigroup_posters')) {
		...
		if (!$this->hasTable('page_contents')) {
		...
		if (!$this->hasTable('predb_imports')) {
		...
		if (!$this->hasTable('release_comments')) {
		...
		if (!$this->hasTable('release_files')) {
		...
		if (!$this->hasTable('release_naming_regexes')) {
		...
		if (!$this->hasTable('release_search_data')) {
		...
		if (!$this->hasTable('release_subtitles')) {
		...
		if (!$this->hasTable('release_unique')) {
		...
		if (!$this->hasTable('releases_groups')) {
		...
		if (!$this->hasTable('role_excluded_categories')) {
		...
		if (!$this->hasTable('sharing_sites')) {
		...
		if (!$this->hasTable('upcoming_releases')) {
		...
		if (!$this->hasTable('user_downloads')) {
		...
		if (!$this->hasTable('user_excluded_categories')) {
		...
		if (!$this->hasTable('user_requests')) {
		...
		if (!$this->hasTable('users_releases')) {
		...
		if (!$this->hasTable('video_aliases')) {
