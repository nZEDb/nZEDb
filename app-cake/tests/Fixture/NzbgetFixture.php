 ...
 * NzbgetFixture
 */
class NzbgetFixture extends TestFixture
{
    /**
     * Table name
     *
    ...
    public $fields = [
        ...
        'url' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => 'url to NZBGet server', 'precision' => null, 'fixed' => null],
