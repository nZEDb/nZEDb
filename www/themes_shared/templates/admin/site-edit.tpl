	...
	<table class="input">
		<tr>
			...
			<td>
				...
				<div class="hint">Displayed around the site and contact form as the name for the
								  site.
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<textarea id="metadescription"
					name="metadescription">{$fsite->metadescription}</textarea>

				<div class="hint">Stem meta-description appended to all page meta description
								  tags.
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				<input id="home_link"
					...
					name="home_link"
					type="text"
					value="{$fsite->home_link}" />

				<div class="hint">The relative path to a the landing page shown when a user logs in,
								  or clicks the home
								  link.
				</div>
			</td>
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The theme folder which will be loaded for css and images. (Use /
								  for default)
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">Where the menu should appear. Moving the menu to the top will
								  require using a theme
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Shown in the contact us page, and where the contact html form is
								  sent to.
				</div>
			</td>
		</tr>
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Location of log file (MUST be set if logging to file is set).
				</div>
			</td>
		</tr>
	</table>
	...
	<table class="input">
		<tr>
			...
			<td>
				...
				<div class="hint">This only works if the above is set to english. Whether to send
								  foreign movies/tv to
								  foreign sections or not. If set to true they will go in foreign
								  categories.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">Whether to send WEB-DL to the WEB-DL section or not. If set to
								  true they will go in
								  WEB-DL category, false will send them in HD TV.<br />This will
								  also make them inaccessible to
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Akas.imdb.com returns titles in their original title, imdb.com
								  returns titles based on
								  your IP address (if you are in france, you will get french
								  titles).
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">Which language to lookup when sending requests to IMDB/Tmdb. (If
								  akas.imdb.com is set,
...
<fieldset>
	...
	<table class="input">
		<tr>
			<td style="width:180px;"><label for="google_analytics_acc">Google Analytics:</label>
			</td>
			<td>
		...
		<tr>
			<td style="width:180px;"><label for="google_adsense_search">Google Adsense
																		Search:</label></td>
			<td>
				<input id="google_adsense_search" name="google_adsense_search" type="text"
					value="{$fsite->google_adsense_search}" />

				<div class="hint">The ID of the google search ad panel displayed at the bottom of
								  the left menu.
				</div>
			</td>
		</tr>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The api key used for access to rotten tomatoes. Select the quality
								  of the images to
								  display in Upcoming.
				</div>
			</td>
		...
		<tr>
			...
			<td>
				<input id="amazonpubkey"
					class="long"
					name="amazonpubkey"
					type="text"
					value="{$fsite->amazonpubkey}" />
		...
		<tr>
			<td style="width:180px;"><label for="amazonassociatetag">Amazon Associate Tag:</label>
			</td>
			<td>
		...
		<tr>
			...
			<td>
				<input id="fanarttvkey"
					class="long"
					name="fanarttvkey"
					type="text"
					value="{$fsite->fanarttvkey}" />

				<div class="hint">The Fanart.tv api key. Used for Fanart.tv lookups. Fanart.tv would
								  appreciate it if
								  you use this service to help them out by adding high quality
								  images not already available on TMDB.
				</div>
			</td>
		</tr>
	</table>
...
<fieldset>
	...
	<table class="input">
		<tr>
			...
			<td>
				<input id="unrarpath"
					...
					name="unrarpath"
					type="text"
					value="{$fsite->unrarpath}" />

				<div class="hint">The path to an unrar binary, used in deep password detection and
								  media info grabbing.
		...
		<tr>
			...
			<td>
				<input id="tmpunrarpath"
					class="long"
					name="tmpunrarpath"
					type="text"
					value="{$fsite->tmpunrarpath}" />

				<div class="hint">The path to where unrar puts files. WARNING: This directory will
								  have its contents
								  deleted.
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The path to the 7za (7zip command line in windows) binary, used
								  for grabbing nfos from
		...
		<tr>
			...
			<td>
				...
				<div class="hint">
					...
					<br />Putting the path to yydecode will use yydecode, which is faster than PHP.
					<a
						style="color:#0082E1"
						href="http://sourceforge.net/projects/yydecode/files/yydecode/0.2.10/">Download
																							   ...
																							   on
																							   sourceforce.</a>
					<br />Putting in <strong style="color:#ac2925">simple_php_yenc_decode</strong>
					will use that
					extension which is even faster <strong>(you must have the extension)</strong>.
					<a
						style="color:#0082E1"
						href="https://github.com/kevinlekiller/simple_php_yenc_decode">View
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The path to the <a href="http://mediainfo.sourceforge.net">mediainfo</a>
								  binary. Used
								  for deep file media analysis. Use empty path to disable mediainfo
								  checks
	...
	<table class="input">
		<tr>
			...
			<td>
				...
				<div class="hint">
					Whether to allow integration with a SAB install and if so what type of
					integration.<br />
					<strong>Setting this to integrated also disables NZBGet from being selectable to
							the
							user.</strong><br />
				</div>
			</td>
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The url of the SAB installation, for example:
		...
		<tr>
			...
			<td>
				<input id="sabapikey"
					...
					name="sabapikey"
					type="text"
					value="{$fsite->sabapikey}" />

				<div class="hint">The Api key of the SAB installation. Can be the full api key or
								  the nzb api key (as of
								  SAB 0.6)
				</div>
			</td>
		</tr>
...
<tr>
	<td style="width:180px;"><label for="minfilestoformrelease">Minimum Files to Make a
																Release:</label></td>
	<td>
...
<tr>
	<td style="width:180px;"><label for="minsizetoformrelease">Minimum File Size to Make a
															   Release:</label></td>
	<td>
...
<tr>
	...
	<td>
		...
		<div class="hint">The maximum total size in bytes to make a release. If set to 0, then
						  ignored. Only deletes
						  during release creation.
		</div>
	</td>
...
<tr>
	<td style="width:180px;"><label for="maxsizetopostprocess">Maximum File Size to
...
<tr>
	<td style="width:180px;"><label for="checkpasswordedrar">Check For Passworded Releases:</label>
	</td>
	<td>
...
<tr>
	<td style="width:180px;"><label for="deletepasswordedrelease">Delete Passworded
																  Releases:</label></td>
	<td>
...
<tr>
	<td style="width:180px;"><label for="showpasswordedrelease">Show Passworded Releases:</label>
	</td>
	<td>
		...
		<div class="hint">Whether to show passworded or potentially passworded releases in browse,
						  search, api and rss
						  feeds. Potentially passworded means releases which contain .cab or .ace
						  files which are typically password
						  protected.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to retrieve a JPG file while additional post
						  processing, these are usually
...
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to process a video sample, these videos are very short
						  1-3 seconds, 100KB
...
<tr>
	...
	<td>
		...
		<div class="hint">The maximum number of segments to download to generate the sample video
						  file or jpg sample
						  image. (Default 2)
		</div>
	</td>
...
<tr>
	<td style="width:180px;"><label for="ffmpeg_duration">Video sample file duration for
														  ffmpeg:</label></td>
	<td>
		<input class="short"
			id="ffmpeg_duration"
...
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to process a audio sample, they will be up to 30
						  seconds, in ogg format.
...
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to find a better name for releases in misc->other using
						  the PAR2 file.<br /><strong>NOTE:
													  this can be slow depending on the
													  group!</strong></div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">When going through PAR2 files, add them to the RAR file content list of
						  the NZB.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to retrieve an nfo file from usenet when processing
						  binaries.<br /><strong>NOTE:
												 disabling nfo lookups will disable movie
												 lookups.</strong></div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup tv rage ids on the web when processing
						  binaries.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup film information from IMDB or TheMovieDB when
						  processing
						  binaries.
		</div>
	</td>
...
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup music information from Amazon when processing
						  binaries.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup game information from Amazon when processing
						  binaries.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup book information from Amazon when processing
						  binaries.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		...
		<div class="hint">Categories of Books to lookup information for (only work if Lookup Books
						  is set to yes).
		</div>
		</div>
	</td>
...
<tr>
	...
	<td>
		...
		<div class="hint">Whether to attempt to lookup Request IDs using the Request ID link
						  below.
		</div>
	</td>
</tr>
<tr>
	...
	<td>
		<input id="request_url"
			class="long"
			name="request_url"
			type="text"
			value="{$fsite->request_url}" />

		<div class="hint">Optional URL to lookup Request IDs. [REQUEST_ID] gets replaced with the
						  request ID from the
...
<tr>
	<td style="width:180px;"><label for="request_hours">Max hours to recheck Request IDs:</label>
	</td>
	<td>
		<input id="request_hours"
			class="short"
			name="request_hours"
			type="text"
			value="{$fsite->request_hours}" />

		<div class="hint">The maximum hours after a release is added to recheck for a Request ID
						  match.
		</div>
	</td>
</tr>
...
<tr>
	...
	<td>
		...
		<div class="hint">Scan back X (posts/days) for each new group? Can backfill to scan
						  further.
		</div>
	</td>
</tr>
...
<fieldset>
	...
	<table class="input">
		<tr>
			<td style="width:180px;"><label for="nzbsplitlevel">Nzb File Path Level Deep:</label>
			</td>
			<td>
		...
		<tr>
			<td style="width:180px;"><label for="releaseretentiondays">Release Retention:</label>
			</td>
			<td>
				<input class="short" id="releasedays" name="releaseretentiondays" type="text"
					value="{$fsite->releaseretentiondays}" />

				<div class="hint">!!THIS IS NOT HEADER RETENTION!! The number of days releases will
								  be retained for use
		...
		<tr>
			<td style="width:180px;"><label for="partretentionhours">Part Retention Hours:</label>
			</td>
			<td>
				<input class="short" id="parthours" name="partretentionhours" type="text"
					value="{$fsite->partretentionhours}" />

				<div class="hint">The number of hours incomplete parts and binaries will be
								  retained.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="miscotherretentionhours">Misc->Other Retention
																		  Hours:</label></td>
			<td>
				<input class="short" id="miscotherhours" name="miscotherretentionhours" type="text"
					value="{$fsite->miscotherretentionhours}" />

				<div class="hint">The number of hours releases categorized as Misc->Other will be
								  retained. Set to 0 to
								  disable.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">The minimum completion % to keep a release. Set to 0 to disable.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input class="short"
					...
					name="delaytime"
					type="text"
					value="{$fsite->delaytime}" />

				<div class="hint">The time in hours to wait, since last activity, before releases
								  without parts counts
								  in the subject are are created<br \> Setting this below 2 hours
								  could create incomplete releases..
				</div>
			</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<td>
				<input class="short"
					...
					name="maxmssgs"
					type="text"
					value="{$fsite->maxmssgs}" />

				<div class="hint">The maximum number of messages to fetch at a time from the server.
								  Only raise this if
		...
		<tr>
			...
			<td>
				...
				<div class="hint">The maximum amount of NZB files to create on stage 5 in
								  update_releases.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">The maximum amount of articles to attempt to repair at a time. If
								  you notice that you
								  are getting a lot of parts into the partrepair table, it is
								  possible that you USP is not keeping up
								  with the requests. Try to reduce the threads to safe scripts, stop
								  using safe scripts or stop using
								  nntpproxy until improves. Ar least until the cause can be
								  determined.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				...
				<div class="hint">Whether to attempt to repair parts or not, increases
								  backfill/binaries updating
								  time.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="safepartrepair">Part Repair for Backfill
																 Scripts:</label></td>
			<td>
				...
				<div class="hint">Whether to put unreceived parts into partrepair table when running
								  binaries(safe) or
								  backfill scripts.
				</div>
			</td>
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Whether to update download counts when someone downloads a
								  release.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="showdroppedyencparts">Log Dropped Headers:</label>
			</td>
			<td>
				...
				<div class="hint">For developers. Whether to log all headers that have 'yEnc' and
								  are dropped. Logged to
		...
		<tr>
			...
			<td>
				...
				<div class="hint">This uses separate tables for collections, binaries and parts for
								  each group.<br />This
								  requires you to run convert_to_tpg.php or
								  reset_truncate.php.<br />This requires that you also run
								  releases_threaded.py.
					<br />Run: show variables like '%open%files%'; results should be higher than
								  10k, twice that if you
								  are using TokuDB.;
					<br /><b>You may need to increase table_open_cache, open_files_limit and
							 max_allowed_packet in
							 my.cnf. Also, you may need to add the following to
							 /etc/security/limits.conf<br />mysql soft
...
<fieldset>
	...
	<table class="input">
		<tr>
			<td style="width:180px;"><label for="maxaddprocessed">Maximum add PP per run:</label>
			</td>
			<td>
				<input class="short" id="maxaddprocessed" name="maxaddprocessed" type="text"
					value="{$fsite->maxaddprocessed}" />

				<div class="hint">The maximum amount of releases to process for
								  passwords/previews/mediainfo per run.
								  Every release gets processed here. This uses NNTP an connection, 1
								  per thread. This does not query
								  Amazon.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="maxpartsprocessed">Maximum add PP parts
																	downloaded:</label></td>
			<td>
				<input class="short" id="maxpartsprocessed" name="maxpartsprocessed" type="text"
					value="{$fsite->maxpartsprocessed}" />

				<div class="hint">If a part fails to download while post processing, this will retry
								  up to the amount
		...
		<tr>
			<td style="width:180px;"><label for="passchkattempts">Maximum add PP parts
																  checked:</label></td>
			<td>
				<input class="short" id="passchkattempts" name="passchkattempts" type="text"
					value="{$fsite->passchkattempts}" />

				<div class="hint">This overrides the above setting if set above 1. How many parts to
								  check for a
								  password before giving up. This slows down post processing
								  massively, better to leave it 1.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="maxnfoprocessed">Maximum NFO files per run:</label>
			</td>
			<td>
				<input class="short" id="maxnfoprocessed" name="maxnfoprocessed" type="text"
					value="{$fsite->maxnfoprocessed}" />

				<div class="hint">The maximum amount of NFO files to process per run. This uses NNTP
								  an connection, 1
		...
		<tr>
			<td style="width:180px;"><label for="maxrageprocessed">Maximum TVRage per run:</label>
			</td>
			<td>
				<input class="short" id="maxrageprocessed" name="maxrageprocessed" type="text"
					value="{$fsite->maxrageprocessed}" />

				<div class="hint">The maximum amount of TV shows to process with TVRage per run.
								  This does not use an
								  NNTP connection or query Amazon.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="maximdbprocessed">Maximum movies per run:</label>
			</td>
			<td>
				<input class="short" id="maximdbprocessed" name="maximdbprocessed" type="text"
					value="{$fsite->maximdbprocessed}" />

				<div class="hint">The maximum amount of movies to process with IMDB per run. This
								  does not use an NNTP
								  connection or query Amazon.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="maxanidbprocessed">Maximum anidb per run:</label>
			</td>
			<td>
				<input class="short" id="maxanidbprocessed" name="maxanidbprocessed" type="text"
					value="{$fsite->maxanidbprocessed}" />

				<div class="hint">The maximum amount of anime to process with anidb per run. This
								  does not use an NNTP
								  connection or query Amazon.
				</div>
			</td>
		...
		<tr>
			<td style="width:180px;"><label for="maxmusicprocessed">Maximum music per run:</label>
			</td>
			<td>
				<input class="short" id="maxmusicprocessed" name="maxmusicprocessed" type="text"
					value="{$fsite->maxmusicprocessed}" />

				<div class="hint">The maximum amount of music to process with amazon per run. This
								  does not use an NNTP
								  connection.
				</div>
			</td>
		...
		<tr>
			<td style="width:180px;"><label for="maxgamesprocessed">Maximum games per run:</label>
			</td>
			<td>
				<input class="short" id="maxgamesprocessed" name="maxgamesprocessed" type="text"
					value="{$fsite->maxgamesprocessed}" />

				<div class="hint">The maximum amount of games to process with amazon per run. This
								  does not use an NNTP
								  connection.
				</div>
			</td>
		...
		<tr>
			<td style="width:180px;"><label for="maxbooksprocessed">Maximum books per run:</label>
			</td>
			<td>
				<input class="short" id="maxbooksprocessed" name="maxbooksprocessed" type="text"
					value="{$fsite->maxbooksprocessed}" />

				<div class="hint">The maximum amount of books to process with amazon per run. This
								  does not use an NNTP
								  connection
				</div>
			</td>
		...
		<tr>
			<td style="width:180px;"><label for="fixnamesperrun">fixReleaseNames per Run:</label>
			</td>
			<td>
				<input class="short" id="fixnamesperrun" name="fixnamesperrun" type="text"
					value="{$fsite->fixnamesperrun}" />

				<div class="hint">The maximum number of releases to check per run(threaded script
								  only).
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input class="short"
					...
					name="amazonsleep"
					type="text"
					value="{$fsite->amazonsleep}" />

				<div class="hint">Sleep time in milliseconds to wait in between amazon requests. If
								  you thread
								  post-proc, multiply by the number of threads. ie Postprocessing
								  Threads = 12, Amazon sleep time =
...
<fieldset>
	...
	<table class="input">
		<tr>
			<td style="width:180px;"><label for="compressedheaders">Use Compressed Headers:</label>
			</td>
			<td>
				...
				<div class="hint">Some servers allow headers to be sent over in a compressed format.
								  If enabled this
								  will use much less bandwidth, but processing times may
								  increase.<br />
								  If you notice that update binaries or backfill seems to hang, look
								  in htop and see if a group is
								  being processed. If so, first try disabling compressed headers and
								  let run until it processes the
		...
		<tr>
			...
			<td>
				<input class="short"
					...
					name="nntpretries"
					type="text"
					value="{$fsite->nntpretries}" />

				<div class="hint">The maximum number of retry attmpts to connect to nntp provider.
								  On error, each retry
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Using the NNTP Proxy for nZEDb can improve performance of nZEDb
								  dramatically. It uses
								  connection pooling which not only give more control over the
								  number of connections to use but also
								  reduces time for connection setup/teardown. The proxy also takes
								  care of compressed headers for you.
								  To use this featrure you will need to install pynntp (sudo pip
								  install pynntp or sudo easy_install
								  pynntp) and socketpool (sudo pip install socketpool or sudo
								  easy_install socketpool) (ensure python2
								  is default) and edit the configuration file (nntpproxy.conf and
								  nntpproxy_a.conf) in the
								  update_scripts/python_scripts/lib (copy sample) directory and
								  finally edit your www/config.php file
								  to use the proxy (username and password are ignored by the proxy -
								  make then anything you like - the
								  proxy doesn't use ssl either). Make sure you turn off the use
								  compressed headers option here in site
								  preferences (the proxy uses compressed headers by default and
								  passes on decompressed data).
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="alternate_nntp">Alternate NNTP Provider:</label>
			</td>
			<td>
				...
				<div class="hint">This sets Postproccessing Additional/Nfo to use the alternate NNTP
								  provider as set in
								  config.php.
				</div>
			</td>
...
<fieldset>
	...
	<table class="input">
		<tr>
			<td style="width:180px;"><label for="binarythreads">Update Binaries Threads:</label>
			</td>
			<td>
				<input class="short" id="binarythreads" name="binarythreads" type="text"
					value="{$fsite->binarythreads}" />

				<div class="hint">The number of threads for update_binaries. If you notice that you
								  are getting a lot of
								  parts into the partrepair table, it is possible that you USP is
								  not keeping up with the requests.
								  Try to reduce the threads to safe scripts, stop using safe scripts
								  or stop using nntpproxy until
		...
		<tr>
			<td style="width:180px;"><label for="releasesthreads">Update Releases Threads:</label>
			</td>
			<td>
				<input class="short" id="releasesthreads" name="releasesthreads" type="text"
					value="{$fsite->releasesthreads}" />

				<div class="hint">The number of threads for update_releases. This is only for
								  tablepergroup.
				</div>
			</td>
		</tr>
		<tr>
			...
			<td>
				<input class="short"
					...
					name="nzbthreads"
					type="text"
					value="{$fsite->nzbthreads}" />

				<div class="hint">The number of threads for import-nzb(bulk). This will thread each
								  subfolder.
				</div>
			</td>
		</tr>
		<tr>
			<td style="width:180px;"><label for="postthreads">Postprocessing Additional
															  Threads:</label></td>
			<td>
				<input class="short"
					id="postthreads"
					name="postthreads"
					type="text"
					value="{$fsite->postthreads}" />

				<div class="hint">The number of threads for additional postprocessing. This includes
								  deep rar
		...
		<tr>
			<td style="width:180px;"><label for="postthreadsnon">Postprocessing Non-Amazon
																 Threads:</label></td>
			<td>
				<input class="short" id="postthreadsnon" name="postthreadsnon" type="text"
					value="{$fsite->postthreadsnon}" />

				<div class="hint">The number of threads for non-amazon postprocessing. This includes
								  movies, anime and
								  tv lookups.
				</div>
			</td>
		...
		<tr>
			<td style="width:180px;"><label for="fixnamethreads">fixReleaseNames Threads:</label>
			</td>
			<td>
				<input class="short" id="fixnamethreads" name="fixnamethreads" type="text"
					value="{$fsite->fixnamethreads}" />

				<div class="hint">The number of threads for fixReleasesNames. This includes md5,
								  nfos and filenames.
				</div>
			</td>
		</tr>
	...
	<table class="input">
		...
		<tr>
			...
			<td>
				...
				<div class="hint">Whether to store the users ip address when they signup or login.
				</div>
			</td>
		</tr>
	</table>
