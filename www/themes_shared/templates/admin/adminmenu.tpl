				...
				<li class="has-sub"><a href="#">Regex</a>
					<ul>
						...
						<li class="has-sub"><a href="#">Collections</a>
							<ul>
								<li><a href="{$smarty.const.WWW_TOP}/collectionsregex-edit.php?action=add">Add</a></li>
								<li class="last"><a href="{$smarty.const.WWW_TOP}/collectionsregex-list.php">View</a></li>
							</ul>
						</li>
					</ul>
				</li>
