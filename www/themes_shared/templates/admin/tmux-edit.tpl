	...
	<table class="input">
		<tr>
			...
			<td>
				...
				selected=$ftmux->scrape_cz separator='<br />'}
				<div class="hint">Choose to run IRCScraper on corrupt/zenet irc channels. Setting SCRAPE_IRC_C_Z_BOOL
					parameter to true or false in settings.php will toggle between the servers. The pane for this can
		...
		<tr>
			...
			<td>
				{html_radios id="scrape_efnet" name='scrape_efnet' values=$yesno_ids output=$yesno_names selected=$ftmux->scrape_efnet separator='<br />'}
				<div class="hint">Choose to run IRCScraper on Efnet irc channels. The pane for this can not be created
					after tmux starts.
				</div>
			</td>
		</tr>
