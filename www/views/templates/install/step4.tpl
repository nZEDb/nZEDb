...
{else}
	{if !$cfg->saveConfigCheck}
		<h3><span class="error">Error saving {$cfg->WWW_DIR}/config.php.</span></h3>
		<p>Please save the config.php youself by creating:<br /><b>{$cfg->WWW_DIR}/config.php</b><br />and setting its contents to the following:</p>
