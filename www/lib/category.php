...
class Category
{
	...
	{
		if (preg_match('/[-._ ](XXX|PORNOLATiON|SWE6RUS|masturbation|masturebate|lesbian|cumming|ClubSeventeen|Errotica|Erotica|EroticaX|nymph|sexontv|My_Stepfather_Made_Me)/i', $releasename)) {
