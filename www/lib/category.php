...
class Category
{
	...
	{
		if(preg_match('/[\.\-_ ]AVC|[\.\-_ ]|(B|H)(D|R)RIP|Bluray|BD[\.\-_ ]?(25|50)?|BR|Camrip|[\.\-_ ]\d{4}[\.\-_ ].+(720p|1080p|Cam)|DIVX|[\.\-_ ]DVD[\.\-_ ]|DVD-?(5|9|R|Rip)|Untouched|VHSRip|XVID|[\.\-_ ](DTS|TVrip)[\.\-_ ]/i', $releasename) && !preg_match('/auto(cad|desk)|divx[\.\-_ ]plus|[\.\-_ ]exe$|[\.\-_ ](jav|XXX)[\.\-_ ]|\wXXX(1080p|720p|DVD)|Xilisoft/i', $releasename))
		{
			if($this->categorizeforeign)
			{
	...
	{
		if(!preg_match('/[\.\-_ ](PDTV|PSP|UMD(RIP)?)[\.\-_ ]|x264|[\.\-_ ]XXX[\.\-_ ]|Imageset/i', $releasename))
		{
	...
	{
		if (preg_match('/[\. ](cbr|cbz)|[\( ]c2c|cbr|cbz[\) ]|comix|^\(comic|[\.\-_\(\[ ]comics?[\.\-_ ]|comic.+book|covers.+digital|DC.+(Adventures|Universe)|digital.+(son|zone)|Graphic.+Novel|Total[\.\-_ ]Marvel/i', $releasename))
		{
			$this->tmpCat = Category::CAT_BOOKS_COMICS;
			return true;
		}
	...
	{
		if (preg_match('/^\(?(css|c ?t|Drawing|Gabler|IOS|Iphone|Lynda|Manning|Medic(al|ine)|MIT|No[\.\-_ ]Starch|Packt|Peachpit|Pragmatic|Revista|Servo|SmartBooks|Spektrum|Sybex|Vieweg|Wiley|Woods|Wrox)[\.\-_ ]|[\.\-_ ](Ajax|CSS|DIY|Javascript|(My|Postgre)?SQL|XNA)[\.\-_ ]|3DS\.\-_ ]Max|Adobe|Algebra|Bitdefender|Birkhauser|Britannica|C[\.\-_ ](Sharp|Plus)|Circuits|Cook(book|ing)|(Complete|Definitive|Essential|Practical|Professionals?)[\.\-_ ]Guide|Developer|Diagnostic|Disassembl(er|ing|y)|Debugg(er|ing)|Dreamweaver|Economics|Education|Electronics|Enc(i|y)clopedia|Engineering|Exercizes|Focal[\.\-_ ]Press|For[\.\-_ ]Dummies|FreeBSD|Fundamentals[\.\-_ ]of[\.\-_ ]|(Galileo|Island)[\.\-_ ]Press|Geography|Grammar|Hacking|Handboo?k|How[\.\-_ ](It|To)|Intoduction[\.\-_ ]to|Iphone|jQuery|Lessons[\.\-_ ]In|LibreOffice|Linux|Manual|Masonry|Mathematic(al|s)?|Medical|Microsoft|National[\.\-_ ]Academies|OReilly|OS[\.\-_ ]X[\.\-_ ]|Official[\.\-_ ]Guide|Open(GL|Office)|Periodic.+Table|Photoshop|PowerPC|PowerShell|Programm(ers?|ieren|ing)|Raspberry.+Pi|Remedies|Service\s?Manual|SitePoint|Sketching|Theory|Ubuntu|Visual[\.\-_ ]Studio|Textbook|VMWare|Windows[\.\-_ ](8|7|Vista|XP)|^Wood[\.\-_ ]|Woodwork|WordPress|Workshop/i', $releasename))
		{
			$this->tmpCat = Category::CAT_BOOKS_TECHNICAL;
			return true;
		}
	...
	{
		if (preg_match('/^\(.+( |\.)\d{1,2}( |\.)20\d\d( |\.).+\.scr|[\.\-_ ](Catalogue|FHM|NUTS|Pictorial|Tatler|XXX)[\.\-_ ]|^\(?(Allehanda|Club|Computer([a-z0-9]+)?|Connect \d+|Corriere|Diario|Digit(al)?|Esquire|FHM|Gadgets|Galileo|Glam|GQ|Infosat|Inked|Instyle|io|Kicker|Liberation|New Scientist|NGV|Nuts|Popular|Professional|Reise|Sette(tv)?|Springer|Stuff|Studentlitteratur|Vegetarian|Vegetable|Videomarkt|Wired)[\.\-_ ]|Catalog|Columbus.+Dispatch|Correspondenten|Corriere[\.\-_ ]Della[\.\-_ ]Sera|Dagbladet|Digital[\.\-_ ]Guide|Economist|Eload24|ExtraTime|Fatto[\.\-_ ]Quotidiano|Flight[\.\-_ ](International|Journal)|Finanzwoche|France.+Football|Foto.+Video|Games?(Master|Markt|tar|TM)|Gardening|Gazzetta|Globe[\.\-_ ]And[\.\-_ ]Mail|Heimkino|Hustler|La.+(Lettura|Rblica|Stampa)|Le[\.\-_ ](Monde|Temps)|Les[\.\-_ ]Echos|e?Magazin(es?)?|Mac(life|welt)|Maxim|Men.+(Health|Fitness)|Motocross|Motorcycle|Mountain[\.\-_ ]Bike|MusikWoche|National[\.\-_ ]Geographic|New[\.\-_ ]Yorker|PC([\.\-_ ](Gamer|Welt|World)|Games|Go|Tip)|Penthouse|Photograph(er|ic)|Playboy|Posten|Quotidiano|(Golf|Readers?).+Digest|SFX[\.\-_ ]UK|Recipe.+Guide|SkyNews|Sport[\.\-_ ]?Week|Strategy.+Guide|TabletPC|Tattoo[\.\-_ ]Life|The[\.\-_ ]Guardian|Tageszeitung|Tid(bits|ning)|Top[\.\-_ ]Gear[\.\-_ ]|Total[\.\-_ ]Guitar|Travel[\.\-_ ]Guides?|Tribune[\.\-_ ]De[\.\-_ ]|US[\.\-_ ]Weekly|USA[\.\-_ ]Today|Vogue|Verlag|Web.+Designer|What[\.\-_ ]Car|Zeitung/i', $releasename))
		{
