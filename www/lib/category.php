...
class Category
{
	...
	{
		if (preg_match('/^\(?(atz|bb|css|c ?t|Drawing|Gabler|IOS|Iphone|Lynda|Manning|Medic(al|ine)|MIT|No[\.\-_ ]Starch|Packt|Peachpit|Pragmatic|Revista|Servo|SmartBooks|Spektrum|Sybex|Vieweg|Wiley|Woods|Wrox)[\.\-_ ]|[\.\-_ ](Ajax|CSS|DIY|Javascript|(My|Postgre)?SQL|XNA)[\.\-_ ]|3DS\.\-_ ]Max|Adobe|Algebra|Appleworks|Bitdefender|Birkhauser|Britannica|C[\.\-_ ](Sharp|Plus)|Circuits|Cook(book|ing)|(Beginners?|Complete|Definitive|Essential|Hackers?|Practical|Professionals?)[\.\-_ ]Guide|Developer|Diagnostic|Disassembl(er|ing|y)|Debugg(er|ing)|Dreamweaver|Economics|Education|Electronics|Enc(i|y)clopedia|Engineer(ing|s)|Exercizes|For.+Beginners|Focal[\.\-_ ]Press|For[\.\-_ ]Dummies|FreeBSD|Fundamentals[\.\-_ ]of[\.\-_ ]|(Galileo|Island)[\.\-_ ]Press|Geography|Grammar|Guide[\.\-_ ](For|To)|Hacking|Google|Handboo?k|How[\.\-_ ](It|To)|Intoduction[\.\-_ ]to|Iphone|jQuery|Lessons[\.\-_ ]In|Learning|LibreOffice|Linux|Manual|Marketing|Masonry|Mathematic(al|s)?|Medical|Microsoft|National[\.\-_ ]Academies|Nero[\.\-_ ]\d+|OReilly|OS[\.\-_ ]X[\.\-_ ]|Official[\.\-_ ]Guide|Open(GL|Office)|Periodic.+Table|Photoshop|PowerPC|PowerShell|Programm(ers?|ier||ing)|Raspberry.+Pi|Remedies|Service\s?Manual|SitePoint|Sketching|Stock.+Market|Students|Theory|Ubuntu|Visual[\.\-_ ]Studio|Textbook|VMWare|Windows[\.\-_ ](8|7|Vista|XP)|^Wood[\.\-_ ]|Woodwork|WordPress|Work(book|shop)|Youtube/i', $releasename))
		{
			$this->tmpCat = Category::CAT_BOOKS_TECHNICAL;
			return true;
		}
