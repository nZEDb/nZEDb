...
class Releases
{
	...
	/*
	 * With the new changes this would not work since we don't have a groupID to work from, 
	 * we would need to add the groupID to the binaries table then copy it from the collections to the binaries.
	 */
