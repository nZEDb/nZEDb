<?php /* Smarty version Smarty3-SVN$Rev: 3286 $, created on 2013-04-11 11:09:38
         compiled from "/var/www/newznab/www/views/templates/frontend/music.tpl" */ ?>
<?php /*%%SmartyHeaderCode:11920871395166d232409cc1-65042010%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa5dba8fe9670ed786d811672769512178a99065' => 
    array (
      0 => '/var/www/newznab/www/views/templates/frontend/music.tpl',
      1 => 1365687713,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '11920871395166d232409cc1-65042010',
  'function' => 
  array (
  ),
...
<table class="rndbtn" border="0" cellpadding="2" cellspacing="0">
	...
	<tr>
		<td><input id="musicartist" type="text" name="artist" value="<?php echo $_smarty_tpl->getVariable('artist')->value;?>
" size="15" /></td>
		<td><input id="musictitle" type="text" name="title" value="<?php echo $_smarty_tpl->getVariable('title')->value;?>
" size="15" /></td>
		<td>
...
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['gen']->value['title'],"htmlall");?>
</option>
			<?php }} ?>
			</select>
		</td>
...
<table style="width:100%;" class="data highlight icons" id="coverstable">
	<tr>
		...
		<th>artist<br/><a title="Sort Descending" href="<?php echo $_smarty_tpl->getVariable('orderbyartist_desc')->value;?>
"><img src="<?php echo @WWW_TOP;?>
/views/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="<?php echo $_smarty_tpl->getVariable('orderbyartist_asc')->value;?>
"><img src="<?php echo @WWW_TOP;?>
...
/covers/music/<?php if ($_smarty_tpl->tpl_vars['result']->value['cover']==1){?><?php echo $_smarty_tpl->tpl_vars['result']->value['musicinfoID'];?>
.jpg<?php }else{ ?>no-cover.jpg<?php }?>" width="120" border="0" alt="<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['artist'],"htmlall");?>
...
" name="amazon<?php echo $_smarty_tpl->tpl_vars['result']->value['musicinfoID'];?>
...
">Grp</a>
			...
			<td colspan="7" class="left" id="guid<?php echo $_smarty_tpl->tpl_vars['result']->value['guid'];?>
">
				<h2><a class="title" title="View details" href="<?php echo @WWW_TOP;?>
/details/<?php echo $_smarty_tpl->tpl_vars['result']->value['guid'];?>
/<?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['searchname'],"htmlall");?>
"><?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['artist'],"htmlall");?>
 - <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['title'],"htmlall");?>
</a> (<a class="title" title="<?php echo $_smarty_tpl->tpl_vars['result']->value['year'];?>
" href="<?php echo @WWW_TOP;?>
/music?year=<?php echo $_smarty_tpl->tpl_vars['result']->value['year'];?>
"><?php echo $_smarty_tpl->tpl_vars['result']->value['year'];?>
</a>)</h2>
				<?php if ($_smarty_tpl->tpl_vars['result']->value['genre']!=''){?><b>Genre:</b> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['genre'],"htmlall");?>
<br /><?php }?>
				<?php if ($_smarty_tpl->tpl_vars['result']->value['publisher']!=''){?><b>Publisher:</b> <?php echo smarty_modifier_escape($_smarty_tpl->tpl_vars['result']->value['publisher'],"htmlall");?>
<br /><?php }?>
...
/music?artist=<?php echo $_smarty_tpl->tpl_vars['result']->value['artist'];?>
