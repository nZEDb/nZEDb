<?php
	...
	class nameCleaning
	{
		...
		{
			//Parts/files
			$cleansubject = preg_replace('/\[\d+(\/|(\s|_)of(\s|_)|\-)\d+\]|\(\d+(\/|\sof\s|\-)\d+\)|File\s\d+\sof\s\d{1,4}|\-\s\d{1,3}\/\d{1,3}\s\-|\d{1,3}\/\d{1,3}\]\s\-|\s\d{2,3}(\\|\/)\d{2,3}|^\[\d{1,3}\/\d{1,3}\s\s|\(\d{1,3}\|\d{1,3}\)|\-\s\[\s\d{1,3}\/\d{1,3}\s\]\s\-|\s\d{1,3}\sof\s\d{1,3}|\-\s\d{1,3}\/\d{1,3}\s\"/i', '', $subject);
		...
		{
			//File and part count.
			$cleanerName = preg_replace('/\[\d+(\/|(\s|_)of(\s|_)|\-)\d+\]|\(\d+(\/|\sof\s|\-)\d+\)|File\s\d+\sof\s\d{1,4}|\-\s\d{1,3}\/\d{1,3}\s\-|\d{1,3}\/\d{1,3}\]\s\-|\s\d{2,3}(\\|\/)\d{2,3}\s|^\[\d{1,3}\/\d{1,3}\s|\(\d{1,3}\|\d{1,3}\)|\-\s\[\s\d{1,3}\/\d{1,3}\s\]\s\-|\s\d{1,3}\sof\s\d{1,3}|\-\s\d{1,3}\/\d{1,3}\s\"/i', '', $subject);
			//Size.
