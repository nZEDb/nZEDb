 ...
 <th class="mid">options</th>
	...
	{foreach from=$shows item=show}
		<tr class="{cycle values=",alt"}">
			...
			<td><a href="{$smarty.const.WWW_TOP}/rss?show={$show.id}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}" title="RSS Feed for {$show.releasetitle|stripslashes|escape:"htmlall"} (All Categories)">RSS Feed</td>
