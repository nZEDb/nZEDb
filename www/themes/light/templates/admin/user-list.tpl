...
<table style="width:100%;margin-top:10px;" class="data highlight">
	...
	<tr>
		<th>username<br/><a title="Sort Descending" href="{$orderbyusername_desc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyusername_asc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_up.gif" alt="" /></a></th>
        <th>Real Name</th>
		<th>email<br/><a title="Sort Descending" href="{$orderbyemail_desc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyemail_asc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_up.gif" alt="" /></a></th>
		<th>host<br/><a title="Sort Descending" href="{$orderbyhost_desc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyhost_asc}"><img src="{$smarty.const.WWW_TOP}/../themes/alpha/images/sorting/arrow_up.gif" alt="" /></a></th>
