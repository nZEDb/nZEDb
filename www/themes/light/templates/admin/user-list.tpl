...
<table style="width:100%;margin-top:10px;" class="data highlight">
	...
	<tr>
		<th>username<br/><a title="Sort Descending" href="{$orderbyusername_desc}"><img src="{$smarty.const.WWW_TOP}/../themes_shared/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyusername_asc}"><img src="{$smarty.const.WWW_TOP}/../themes_shared/images/sorting/arrow_up.gif" alt="" /></a></th>
        <th>Real Name</th>
		...
		<th>api requests<br/><a title="Sort Descending" href="{$orderbyapirequests_desc}"><img src="{$smarty.const.WWW_TOP}/../themes_shared/images/sorting/arrow_down.gif" alt="" /></a><a title="Sort Ascending" href="{$orderbyapirequests_asc}"><img src="{$smarty.const.WWW_TOP}/../themes_shared/images/sorting/arrow_up.gif" alt="" /></a></th>
