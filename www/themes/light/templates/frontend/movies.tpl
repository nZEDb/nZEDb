							...
							<div class="movoverlay">
								<div class="movcover" style="float:right;">
									...
									<div class="movextra">
										...
										{if $cpurl != '' && $cpapi != ''}
											<a class="rndbtnsml" target="blackhole" href="{$site->dereferrer_link}{$cpurl}/api/{$cpapi}/movie.add/?identifier=tt{$result.imdbid}&title={$result.title}" name="CP{$result.imdbid}" title="Add to CouchPotato">Couch</a>
										{/if}
									</div>
								</div>
