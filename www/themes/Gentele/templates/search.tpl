				...
				<table class="data table table-striped responsive-utilities jambo-table" id="browsetable">
					...
					{foreach $results as $result}
						<tr class="{cycle values=",alt"}{if $lastvisit|strtotime<$result.adddate|strtotime} new{/if}"
							...
							<td class="files">
								...
								{if $result.rarinnerfilecount > 0}
									<div class="rarfilelist">
										<img src="{$smarty.const.WWW_THEMES}/shared/img/icons/magnifier.png"
											 alt="{$result.guid}">
									</div>
								{/if}
							</td>
							...
							<td>
								<a href="{$smarty.const.WWW_TOP}/getnzb/{$result.guid}" class="icon_nzb text-muted"
								...
								<a href="#" class="icon_cart text-muted" style="background-image: none"><i
											class="fa fa-shopping-basket" data-toggle="tooltip" data-placement="top"
											title
											data-original-title="Send to my download basket"></i></a>
								{if isset($sabintegrated) && $sabintegrated !=""}
									<a href="#" class="icon_sab text-muted" style="background-image: none"><i
