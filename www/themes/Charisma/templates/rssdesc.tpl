...
<ul style="text-align: left;">
	<li>
		...
		<a href="{$smarty.const.WWW_TOP}/rss?t={$category::GAME_ROOT},{$category::MOVIE_ROOT},{$category::MUSIC_MP3}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}">{$smarty.const.WWW_TOP}
			/rss?t={$category::GAME_ROOT},{$category::MOVIE_ROOT},{$category::MUSIC_MP3}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}</a>
	</li>
</ul>
