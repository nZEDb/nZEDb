...
<head>
	...
	<!-- The styles -->
	<link id="bs-css" href="{$smarty.const.WWW_THEMES}/Charisma/css/bootstrap-spacelab.min.css" rel="stylesheet">
	<link href="{$smarty.const.WWW_THEMES}/Charisma/css/charisma-app.css" rel="stylesheet">
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/fullcalendar/dist/fullcalendar.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/fullcalendar/dist/fullcalendar.print.css' rel='stylesheet' media='print'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/chosen/chosen.min.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/colorbox/example3/colorbox.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/responsive-tables/responsive-tables.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/bower_components/bootstrap-tour/build/css/bootstrap-tour.min.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/jquery.noty.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/noty_theme_default.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/elfinder.min.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/elfinder.theme.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/jquery.iphone.toggle.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/uploadify.css' rel='stylesheet'>
	<link href='{$smarty.const.WWW_THEMES}/Charisma/css/animate.min.css' rel='stylesheet'>

	<!-- jQuery -->
	<script src="{$smarty.const.WWW_THEMES}/Charisma/bower_components/jquery/jquery.min.js"></script>
	...
	<!-- The fav icon -->
	<link rel="shortcut icon" href="{$smarty.const.WWW_THEMES}/Charisma/img/favicon.ico">
...
<!-- notification plugin -->
<script src="{$smarty.const.WWW_THEMES}/Charisma/js/jquery.noty.js"></script>
