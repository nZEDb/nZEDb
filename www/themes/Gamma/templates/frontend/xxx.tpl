							...
							<h4>
								<a target="_blank"
								   ...
								   class="modal_xxx thumbnail" rel="viewxxx">
									...
									{else} <img class="shadow img-polaroid" src="{$smarty.const.WWW_TOP}themes/shared/images/no-cover.png" style="max-width: 120px;" width="120" border="0" alt="{$result.title|escape:"htmlall"}"/>
									{/if}
								</a>
							</h4>
							<div class="movextra">
