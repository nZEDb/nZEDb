...
<form name="presearch" method="get" action="{$smarty.const.WWW_TOP}/predb" id="custom-search-form"
	  class="form-inline form-horizontal col-md-4 col-lg-4 pull-right">
	<div id="search" class="input-group col-md-12 col-lg-12">
									...
									<tr class="{cycle values=",alt"}">
										...
										<td class="predb" style="text-align:center;">
											<a
												...
												target="_blank"
											>
												<img src="{$smarty.const.WWW_THEMES}/shared/images/icons/nzbindex.png"/>
												&nbsp;
											</a>
										</td>
										<td class="predb" style="text-align:center;">
											<a
												...
												target="_blank"
											>
												<img src="{$smarty.const.WWW_THEMES}/shared/images/icons/binsearch.png"/>
												&nbsp;
											</a>
										</td>
									</tr>
