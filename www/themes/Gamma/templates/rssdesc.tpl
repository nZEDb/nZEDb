...
<ul style="text-align: left;">
	<li>
		...
		<code><a href="{$smarty.const.WWW_TOP}/rss?t={$catClass::GAME_ROOT},{$catClass::MOVIE_ROOT},{$catClass::MUSIC_MP3}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}">{$smarty.const.WWW_TOP}/rss?t={$catClass::GAME_ROOT},{$catClass::MOVIE_ROOT},{$catClass::MUSIC_MP3}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}</a></code>
	</li><br/>
</ul>
