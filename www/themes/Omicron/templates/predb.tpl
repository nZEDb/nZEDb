											...
											<td class="predb" style="text-align:center;">
												...
												{elseif in_array({$result.category}, array('Other: E-Books'))}
													<a class="title" title="View category Books Other"
													   href="{$smarty.const.WWW_TOP}/browse?t={getCategoryValue('CAT_BOOKS_OTHER')}">Ebooks
														Other</a>
						...
						&searchadvsizefrom=-1&searchadvsizeto=-1&searchadvhasnfo=0&searchadvhascomments=0&search_type=adv"
											...
											<td class="predb" style="text-align:center;">
												<a
														...
														target="_blank"
														>
													<img src="{$smarty.const.WWW_THEMES}/Omicron/images/icons/nzbindex.png"/>
													&nbsp;
												</a>
											</td>
											<td class="predb" style="text-align:center;">
												<a
														...
														target="_blank"
														>
													<img src="{$smarty.const.WWW_THEMES}/Omicron/images/icons/binsearch.png"/>
													&nbsp;
												</a>
											</td>
										</tr>
