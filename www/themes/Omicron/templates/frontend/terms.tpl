...
<head>
	...
	<!-- Bootstrap 3.3.6 -->
	<link href="{$smarty.const.WWW_THEMES}/shared/libraries/bootstrap/v3/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	<!-- Font Awesome Icons -->
	<link href="{$smarty.const.WWW_THEMES}/shared/css/font-awesome.min.css" rel="stylesheet" type="text/css"/>
	<!-- Ionicons -->
	<link href="https://code.ionicframework.com/ionicons/2.0.1/css/ionicons.min.css" rel="stylesheet" type="text/css"/>
	<!-- Theme style -->
	<link href="{$smarty.const.WWW_THEMES}/shared/libraries/AdminLTE/v2/dist/css/AdminLTE.css"
			rel="stylesheet" type="text/css"/>
	<!-- AdminLTE Skins. We have chosen the skin-blue for this starter
		  page. However, you can choose any other skin. Make sure you
		  apply the skin class to the body tag so the changes take effect.
	-->
	<link href="{$smarty.const.WWW_THEMES}/shared/libraries/AdminLTE/v2/dist/css/skins/skin-blue.min.css" rel="stylesheet" type="text/css"/>
	<!-- Newznab utils.js -->
...
<!-- Bootstrap 3.3.2 JS -->
<script src="{$smarty.const.WWW_THEMES}/shared/libraries/bootstrap/v3/js/bootstrap.min.js"
