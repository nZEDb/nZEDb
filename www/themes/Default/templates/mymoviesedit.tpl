	...
	{foreach $movies as $movie}
		<tr class="{cycle values=",alt"}">
			...
			<td class="mid">
				...
				<div class="movcover">
					<img class="shadow" src="{$smarty.const.WWW_TOP}/covers/movies/{if $movie.cover == 1}{$movie.imdbid}-cover.jpg{else}no-cover.jpg{/if}" width="120" alt="{$movie.title|escape:"htmlall"}" />
					<div class="movextra">
