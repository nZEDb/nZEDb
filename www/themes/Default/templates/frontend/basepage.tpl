...
<div id="page">
	...
	{literal}<script>window.jQuery || document.write('<script src="{/literal}{$smarty.const.WWW_THEMES}{literal}/shared/libraries/bootstrap/v3/js/bootstrap.min.js"><\/script>')</script>{/literal}
