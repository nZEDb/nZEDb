...
<div id="page">
	...
	{literal}<script>window.jQuery || document.write('<script src="{/literal}{$smarty.const.WWW_THEMES}{literal}/shared/scripts/bootstrap.min-v3.0.js"><\/script>')</script>{/literal}
