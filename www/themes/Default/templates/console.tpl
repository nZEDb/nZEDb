		...
		<tr>
			...
			<td>
				<select id="category" name="t">
					<option class="grouping" value="{getCategoryValue('GAME_ROOT')}"></option>
		...
		<table style="width:100%;" class="data highlight icons" id="coverstable">
			<tr>
				...
				<th>title<br/><a title="Sort Descending" href="{$orderbytitle_desc}"><img
								src="{$smarty.const.WWW_TOP}/themes/shared/img/sorting/arrow_down.gif"
				...
				<tr class="{cycle values=",alt"}">
					...
					<td colspan="8" class="left" id="guid{$result.grp_release_guid}">
						<h2><a class="title" title="View details"
							   href="{$smarty.const.WWW_TOP}/details/{$result.grp_release_guid}">{$result.title|stripslashes|escape:"htmlall"}
