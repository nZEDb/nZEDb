		...
		<tr>
			...
			<td>
				<select id="category" name="t">
					<option class="grouping" value="{$catClass::XXX_ROOT}"></option>
						...
						></a>
							...
							{if $result.classused == "ade"}
								<a
									...
									><img src="{$smarty.const.WWW_TOP}/themes/shared/img/icons/ade.png"></a>
								{else}
								<a
									target="_blank"
							...
							<a
								...
								><img src="{$smarty.const.WWW_TOP}/themes/shared/img/icons/aebn.png"></a>
							{/if}
							...
							<a
								...
								><img src="{$smarty.const.WWW_TOP}/themes/shared/img/icons/popporn.png"></a>
							{else}
							<a
								target="_blank"
							...
							<a
								...
								><img src="{$smarty.const.WWW_TOP}/themes/shared/img/icons/iafd.png"></a>
						</div>
						<hr>
						<div>
							<a
