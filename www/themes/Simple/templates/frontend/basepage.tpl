...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <!-- <link href="{$smarty.const.WWW_TOP}/themes/shared/styles/subnav.css" rel="stylesheet" media="screen"> -->
    ...
    <body {$page->body}>
        <div id="outer">
            ...
            <div id="logo">
                <a class="logolink" title="{$site->title} Logo" href="{$smarty.const.WWW_TOP}{$site->home_link}"><img class="logoimg" alt="{$site->title} Logo" src="{$smarty.const.WWW_TOP}/themes/shared/images/clearlogo.png" /></a>
            ...
            <!-- <script src="{$smarty.const.WWW_TOP}/themes/shared/scripts/subnav.js"></script> -->
