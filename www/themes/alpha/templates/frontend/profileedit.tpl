...
<form class="form-group" action="profileedit?action=submit" method="post">
	...
	{if $page->pdo->getSetting('sabintegrationtype') != 1}
		<fieldset>
	...
	{/if}
	{if $user.queuetype == 2 && ($page->pdo->getSetting('sabintegrationtype') == 0 || $page->pdo->getSetting('sabintegrationtype') == 2)}
		<fieldset>
	...
	{/if}
	{if $user.queuetype == 1 && $page->pdo->getSetting('sabintegrationtype') == 2}
		<fieldset>
