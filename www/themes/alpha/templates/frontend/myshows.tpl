	...
	<table class="table table-condensed table-highlight table-striped data Sortable" id="browsetable">
		...
		{foreach from=$shows item=show}
			<tr class="{cycle values=",alt"}">
				...
				<td><a href="{$smarty.const.WWW_TOP}/rss?rage={$show.videos_id}&amp;dl=1&amp;i={$userdata.id}&amp;r={$userdata.rsstoken}" title="RSS Feed for {$show.title|stripslashes|escape:"htmlall"} (All Categories)"><i class="icon-rss-sign" style="color:orange;"></i> RSS Feed</td>
