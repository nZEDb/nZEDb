...
if ($cfg->PDOCheck === false) { $cfg->error = true; }
...
if ($cfg->previewCoversCheck === false) { $cfg->error = true; }

$cfg->sampleCoversCheck = is_writable($cfg->WWW_DIR.'/covers/sample');
if ($cfg->sampleCoversCheck === false) { $cfg->error = true; }

$cfg->videoCoversCheck = is_writable($cfg->WWW_DIR.'/covers/video');
if ($cfg->videoCoversCheck === false) { $cfg->error = true; }
