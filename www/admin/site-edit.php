...
$page->smarty->assign('imdblang_ids', ['en', 'da', 'nl', 'fi', 'fr', 'de', 'it', 'tlh', 'no', 'po', 'ru', 'es', 'sv']);
$page->smarty->assign('imdblang_names', ['English', 'Danish', 'Dutch', 'Finnish', 'French', 'German', 'Italian', 'Klingon', 'Norwegian', 'Polish', 'Russian', 'Spanish', 'Swedish']);
...
$page->smarty->assign('rottentomatoquality_names', ['Thumbnail', 'Profile', 'Detailed', 'Original']);
...
$page->smarty->assign('passworded_names', ['Don\'t show passworded or potentially passworded', 'Don\'t show passworded', 'Show everything']);
...
$page->smarty->assign('loggingopt_names', ['Disabled', 'Log in DB only', 'Log both DB and file', 'Log only in file']);
