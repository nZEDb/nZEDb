...
if (isset($_REQUEST["id"])) {
	...
	switch($action) {
		case 'submit':
			...
			$xxxmovie->update($id, $_POST['title'], $_POST['tagline'], $_POST['plot'], $genre, $_POST['director'], $_POST['actors'], $_POST['extras'], $_POST['productinfo'], $trailerurl, $_POST['directurl'], $_POST['classused'], $_POST['cover'], $_POST['backdrop']);
