...
$ft1 = $db->queryDirect("SHOW INDEX FROM releases WHERE key_name = 'ix_releases_name_searchname_ft'");
$ft2 = $db->queryDirect("SHOW INDEX FROM releases WHERE key_name = 'ix_releases_name_ft'");
$ft3 = $db->queryDirect("SHOW INDEX FROM releases WHERE key_name = 'ix_releases_searchname_ft'");
