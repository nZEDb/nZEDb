...
if (isset($_GET["type"]) && $_GET["type"] == "xml") {
	...
	$page->title = $page->pdo->getSetting('title') . " site map";
	$page->meta_title = $page->pdo->getSetting('title') . " site map";
	$page->meta_keywords = "sitemap,site,map";
	$page->meta_description = $page->pdo->getSetting('title') . " site map shows all our pages.";
