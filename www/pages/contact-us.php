...
if (isset($_POST["useremail"])) {
	...
	if ($captcha->getError() === false) {
		...
		$msg = "<h2 style='text-align:center;'>Thank you for getting in touch with " . Settings::value('title') . ".</h2>";
	}
}
$page->smarty->assign("msg", $msg);
$page->title = "Contact " . Settings::value('title');
$page->meta_title = "Contact " . Settings::value('title');
$page->meta_keywords = "contact us,contact,get in touch,email";
$page->meta_description = "Contact us at " . Settings::value('title') . " and submit your feedback";
