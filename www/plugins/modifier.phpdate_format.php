...
load_plugin_dependency('shared.make_timestamp.php');
	...
	if (substr($format, 0, 5) == 'DATE_') {
		switch ($format) {
			...
			case 'DATE_ISO8601':
				...
				break;
			case 'DATE_RFC822': //The php constant is not quite right - as the time-zone comes out with invalid values like "UTC"...
