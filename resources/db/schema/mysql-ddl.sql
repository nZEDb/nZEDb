...
CREATE TABLE movieinfo (
  id          INT(10) UNSIGNED               NOT NULL AUTO_INCREMENT,
  imdbid      MEDIUMINT(8) UNSIGNED ZEROFILL NOT NULL,
...
CREATE TABLE videos (
  ...
  country_id   CHAR(2) COLLATE utf8_unicode_ci NOT NULL DEFAULT '' COMMENT 'Two character country code (FK to countries table).',
  ...
  PRIMARY KEY    (id),
  UNIQUE KEY     ix_videos_title (title, type, started, country_id),
