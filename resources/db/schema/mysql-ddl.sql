...
CREATE TABLE releasevideo (
  ...
  videoaspect     VARCHAR(10)
                  COLLATE utf8_unicode_ci DEFAULT NULL,
  videoframerate  FLOAT(7, 4) DEFAULT NULL,
  videolibrary    VARCHAR(50)
                  COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE releaseaudio (
  ...
  audioformat      VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiomode        VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiobitratemode VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiobitrate     VARCHAR(10)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiochannels    VARCHAR(25)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiosamplerate  VARCHAR(25)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiolibrary     VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiolanguage    VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  audiotitle       VARCHAR(50)
                   COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (id)
)
  ENGINE =MyISAM
