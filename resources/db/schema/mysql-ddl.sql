...
CREATE TABLE tv_info (
  ...
  publisher VARCHAR(255)  CHARSET = utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'The channel/network of production/release (ABC, BBC, Showtime, etc.).',
...
CREATE TABLE videos (
  ...
  title        VARCHAR(255) CHARSET = utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'Name of the video.',
