...
BEGIN
  ...
  DECLARE cur1 CURSOR FOR
    ...
    WHERE TABLE_SCHEMA = databaseName COLLATE utf8_unicode_ci
    AND (TABLE_NAME LIKE "binaries\_%"
    OR TABLE_NAME="binaries");
  ...
  OPEN cur1;
    myloop: loop FETCH cur1 INTO _table;
      ...
      SET @sql4 := CONCAT("INSERT INTO ", _table, "_tmp SELECT id, name, collection_id, filenumber, totalparts, currentparts, UNHEX(binaryhash), partcheck, partsize FROM ",_table);
