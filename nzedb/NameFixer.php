...
class NameFixer
{
	...
	public function __construct(array $options = [])
	{
		...
		$this->timeother = ' AND rel.adddate > (NOW() - INTERVAL 6 HOUR) AND rel.categoryid IN (1090, 2020, 3050, 6050, 5050, 0010, 0020, 7050) GROUP BY rel.id ORDER BY postdate DESC';
		$this->timeall = ' AND rel.adddate > (NOW() - INTERVAL 6 HOUR) GROUP BY rel.id ORDER BY postdate DESC';
		$this->fullother = ' AND rel.categoryid IN (1090, 2020, 3050, 6050, 5050, 0010, 0020, 7050) GROUP BY rel.id';
		$this->fullall = '';
		$this->_fileName = '';
