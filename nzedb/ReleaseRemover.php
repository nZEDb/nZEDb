			...
			foreach ($regexList as $regex) {
				...
				if ($this->crapTime === '') {
					...
					$ftMatch = (nZEDb_RELEASE_SEARCH_TYPE == ReleaseSearch::SPHINX
						? sprintf('rse.query = "@@relaxed @(name,searchname) %s @filename %1\$s;index=releases_rt,release_files_rt;limit=10000;maxmatches=10000;mode=any" AND', str_replace('|', ' ', str_replace('"', '', $regexMatch)))
