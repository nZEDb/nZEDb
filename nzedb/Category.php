...
class Category
{
	...
	{
		if (preg_match('/1080(i|p)|720p|720p\.HDTV|BDRip\.x264/i', $releasename)) {
	...
	{
		if (preg_match('/(360|480|576)p|Complete[-._ ]Season|dvdr(ip)?|dvd5|dvd9|SD[-._ ]TV|TVRip|BDRip|hdtv|xvid/i', $releasename)) {
			$this->tmpCat = Category::CAT_TV_SD;
			return true;
		}
