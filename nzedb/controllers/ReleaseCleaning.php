...
class ReleaseCleaning
{
	...
	public function _3d()
	{
		...
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //"pandas.3d.back.to.the.wild.h-sbs.fs-3d.r22" - 1.55 GB - yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function amazing()
	{
		...
		if (preg_match('/^\(\?+\) \[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(Ass Backwards (2013) WEBrip XviD AC3 (english subs)) [18/35] - "Ass Backwards (2013) WEBrip XviD AC3 (english subs).part17.rar" yEnc
		if (preg_match('/^\([\w!.,&_ ()\[\]\'\`-]{8,}\)[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(Angels4Always) [1/1] - "Vermeulen, John - De tweelingparadox.rar" yEnc
		if (preg_match('/^\(Angels4Always\)[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[\w!.,&_ ()\[\]\'\`-]{8,}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //www.wolfsteamers.info [1/6] - "Wohnen Bauen Leben - Sommer 2014.par2" - 16,46 MB yEnc
		if (preg_match('/^www\.wolfsteamers\.info[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //096XZFUPQ0PxH4441H14fU8V - [34/99] - "096XZFUPQ0PxH4441H14fU8V.part033.rar" yEnc
		if (preg_match('/^\w+[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //05VANmA80DckBho "05VANmA80DckBho.part07.rar"08/94 yEnc
		if (preg_match('/^\w+[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '\d+(\/\d+)[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //(Slaapkop post voor http://the-ultimate-force.org.ua/) [0/7] - "Wham - I'm Your Man (1985).nzb" yEnc
		if (preg_match('/^\(.+the-ultimate-force\.org\.ua\/\)[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(001/101) - P2H - "L62WD8P4U539A7.par2" - 4,66 GB - Z9F6KN7SXRCY845 yEnc
		if (preg_match('/^\(\d+\/\d+\) - P2H - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+([.,]\d+)? [kKmMgG][bB][- ]{0,3}\w+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\)([-_ ]{0,4}(Description|FTTEAM\.INFO))?[-_ ]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[3];
		} //- - [001/242] - "C65JuogI92CwfMo2TiX59.par2" yEnc
		if (preg_match('/^[-_ .]{0,4}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //- "5nivJ7V6Q2jqAR34bZ8m.part46.rar" yEnc
		if (preg_match('/^[-_ .]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //- "7UAF6LE2PDM38NB.par2" - 8,53 GB - yEnc
		if (preg_match('/^[-_ .]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //- [01/10] - "file.xyz" yEnc - [001/107] - "86u1Qr8mm56jGiW7nUPTM.par2" yEnc
		if (preg_match('/^[-_ ]{0,4}\[\d+\/\d+\][-_ ]{0,3}".+" yEnc[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function ath()
	{
		...
		if (preg_match('/^>+Hell-of-Usenet(\.org)?>+( -)? \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '( - \d+[.,]\d+ [kKmMgG][bB])? yEnc$/', $this->subject, $match)) {
			return $match[3];
		...
		if (preg_match('/^<Have Fun> "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' SpongeBoZZ yEnc$/', $this->subject, $match)) {
	...
	public function audio_warez()
	{
		...
		if (preg_match('/^\(\?{4}\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function b4e()
	{
		...
		if (preg_match('/^- "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function barbarella()
	{
		...
		if (preg_match('/^>>> www\.lords-of-usenet\.org <<<.+? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' .+? \[\d+\/\d+\] - .+? yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^.+? (-|\(PW\))\s+\[.+? -\] \[\d+[,.]\d+ [mMkKgG][bB]\] \[\d+\/\d+\] "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		...
		if (preg_match('/^.+?\s{2,}\d+[,.]\d+ [mMkKgG][bB]\s{2,}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '\s{2,}(\d+ B|\d+[,.]\d+ [mMkKgG][bB]) yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function big()
	{
		...
		if (preg_match('/^\(\d+\/\d+\) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[,.]\d+ [mMkKgG][bB] -(re)? yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\([a-z]+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //""Absolute Database Component for BCBuilder 4-6 MultiUser Edit 4.85.rar"" yEnc
		if (preg_match('/^""([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '" yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function bloaf()
	{
		...
		if (preg_match('/^\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[,.]\d+ [mMkKgG][bB] .+? usenet-space.+?yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[,.]\d+ [mMkKgG][bB] - yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function blu_ray()
	{
		...
		if (preg_match(
			'/^[\w-\. ]+[ _-]{0,3}[\(\[]\d+\/\d+[\)\]][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject,
			$match
		)
		) {
			return $match[1];
		...
		if (preg_match('/^[\w-\. ]+[ _-]{0,3}[\(\[]\d+\/\d+[\)\]][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function boneless()
	{
		...
		if (preg_match('/^\((\?{4}|[a-zA-Z]+)\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^.+?\.(info|org)>+ - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		...
		if (preg_match('/^\(aangemeld bij usenet collector\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[.,]\d+ [kKmMgG][bB] .+usenet-space-cowboys\.info.+ yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^brothers-of-usenet\.info.+ - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(024/264) "Enf.S04E02.G.D.H.X-M.vol51+46.PAR2" - 8,27 GB -Enf.S04.G.D.H.X yEnc
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[.,]\d+ [kKmMgG][bB] .+yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //- "Auction Hunters S04E04.HDTV.x264-StarryNights1.nzb" yEnc
		if (preg_match('/.*"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)(\.part\d*|\.rar)?(\.vol.+?"|\.[A-Za-z0-9]{2,4}").+?yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function british_drama()
	{
		...
		if (preg_match('/^.+?[-_ ]{0,3}\d+[xX]\d+[-_ ]{0,3}.+?\[\d+\/\d+\][-_ ]{0,3}.+?"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Vera.3x03.Young.Gods.720p.HDTV.x264-FoV - "vera.3x03.young_gods.720p_hdtv_x264-fov.r00" yEnc
		if (preg_match('/^[a-zA-Z0-9-\.]+ - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^(.+ S\d+E\d+)[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+File \d+ of \d+ - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function cbt()
	{
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' {1,2}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\?+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' Sayco  yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function classic_tv_shows()
	{
		...
		if (preg_match('/^Per REQ - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' .+? \[\d+\/\d+\] yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //By req: "Dennis The Menace - 4x25 - Dennis and the Homing Pigeons.part05.rar" yEnc
		if (preg_match('/^By req: "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //I Spy HQ DVDRips "I Spy - 3x26 Pinwheel.part10.rar" [13/22] yEnc
		if (preg_match('/^[a-zA-Z ]+HQ DVDRips "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \[\d+\/\d+\] yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^[a-zA-Z0-9][a-zA-Z0-9.-]+S\d+E\d+([a-zA-Z0-9.]+)? \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		...
		if (preg_match('/^(Re: )?[a-zA-Z0-9]+.+? (series|Season) \d+ (- )?\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[4];
		}
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \(Not My Rip\).+ \d+ (- \d+) .+ yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(.+\)  "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \[\d+\/(\d+\]) (Last One I Have! )?yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //[EnJoY] =>A Blast from Usenet Past (1/3)<= [00/14] - "Mcdonalds Training Film - 1972 (Vhs-Mpg).part.nzb" yEnc
		if (preg_match('/^.+ Usenet Past .+\[\d+\/(\d+\]) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		} //<OPA_TV> [01/12] - "Yancy Derringer - 03 - Geheime Fracht.par2" yEnc
		if (preg_match('/^<OPA_TV> \[\d+\/(\d+\]) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		...
		if (preg_match('/^.+ [\[\(]\d+( of |\/)(\d+[\]\)])[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[3];
		}
		...
		if (preg_match('/^.+[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' [\[\(]\d+\/(\d+[\]\)]) yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function cores()
	{
		...
		if (preg_match('/^Film - (\[\d+\/\d+\] - )?"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\[Art-Of-Use\.Net\] :: \[.+?\] :: - \[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^brothers-of-usenet\.info\.net.+SSL-News\.info-----(.+) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^<<<usenet-space-cowboys\.info.+secretusenet\.com>>> \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //::: Usejunkies.tk ::: - [01/11] - "DJ Shog - DNA - HD 720p.par2" - 47,76 MB yEnc
		if (preg_match('/^.+Usejunkies.tk.+ \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(5/9) :...Usejunkies.tk...:----"Leawo.Blu-ray.Ripper.v4.4.0.rar.vol003+04.par2" - 30.94 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\).+Usejunkies.tk.+"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(Grimms03e10) [6/9] - "Grimm_S03E10_Eyes_of_the_Beholder.avi.vol007+08.PAR2"Grimm S03E10  yEnc
		if (preg_match('/^\(.+s\d+e\d+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^[a-zA-Z0-9]+ post voor u op www\..+? - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/i', $this->subject, $match)) {
			return $match[1];
	...
	public function dc()
	{
		...
		if (preg_match('/^brothers-of-usenet.+? \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[,.]\d+ [mMkKgG][bB] yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function documentaries()
	{
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \(\d+\/\d+\).+yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^Battlefield S\d S\d+E\d+ "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+? S\d+E\d+ - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  (\d+[,.]\d+ [kKmMgG][bB]ytes) yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' -  \[\d+ of \d+ - \d+([,.]\d+)? [kKmMgG][bB]\] yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //"Lang Lang - Mendelssohn.m4v"  [2/9]  yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^PBS.+\(\d+\/\d+\) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //PBS - Inside Nature's Giants - Big Cats [100 of 101] "PBS - Inside Nature's Giants - Big Cats.m4v.vol970+143.par2" yEnc
		if (preg_match('/^PBS.+\[\d+ of \d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[\w ]+"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '(.+[\(\[]\d+\/\d+[\)\]])?[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //[Walmart - The High Cost of Low Prices]-[28/59] - "wthcolp.part26.rar" yEnc
		if (preg_match('/^\[([\w- ]+)\]-\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[SR09-0013] - "America Revealed E02 Nation On The Move (2012) x264 720p AC3 5.1.nfo" yEnc
		if (preg_match('/^\[[\w- ]+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(World Air Routes.+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^dokus4alle presents \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
	...
	public function ebook()
	{
		...
		if (preg_match('/www.nzbworld.me - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' yEnc/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/(.+)[-_ ]{0,3}[\(\[]\d+\/\d+[\)\]][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '([-_ ]{0,3}yEnc){1,2}$/i', $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^.+ - ([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\.[A-Za-z0-9]{2,4}[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function e_book_flood()
	{
		...
		if (preg_match('/^([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\.[A-Za-z0-9]{2,4}_as found[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //Ben Carson - America the Beautiful- Rediscovering What Made This Nation Great (epub).epub - File 1 of 1 - yEnc
		if (preg_match('/^([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\.[A-Za-z0-9]{2,4}[- ]{0,3}File \d+ of \d+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //Re: Attn Reg143- (Morse 7) The Secret of Annexe 3 - Colin Dexter.mobi [11/14] -  yEnc
		if (preg_match('/^Re: Attn Reg143- ([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\.[A-Za-z0-9]{2,4}[- ]{0,3}\[\d+\/\d+\][- ]{0,4}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^Re: Request[- ]{0,4}\d+[- ]{0,3}([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar|\.7z)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4})[- ]{0,3}\[\d+\/\d+\][- ]{0,4}yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function erotica()
	{
		...
		if (preg_match('/^[><]+Hell-of-Usenet\.org[<>]+ - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Lesbian Crush Diaries 5 XXX DVDRip x264-Pr0nStarS - (01/26) "Lesbian.Crush.Diaries.5.XXX.DVDRip.x264-Pr0nStarS.nfo" - yenc
		if (preg_match('/^[A-Z0-9][a-zA-Z0-9 -]{8,}? - \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - yenc yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^([A-Z0-9][a-zA-Z0-9 ]{8,}?) - File \d+ of \d+ - ".+?' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[A-Z0-9].{8,}? - \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - yenc yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+?usenet-space.+?Powered by.+? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+? \d+\/(\d+.+?)$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^Flapdrol mp4 - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[U4A][-always take the post from the first and original poster!-] - "VIDEOOT-10VSN01.vol27+23.PAR2" yEnc
		if (preg_match('/^\[U4A\]\[.+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^VolSpuitenMetBud - - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //..::kleverig.eu::.. [01/18] - "CQVNAj4WLDW_7Bm8Ax6J.par2" - 686,38 MB yEnc
		if (preg_match('/^.+[Kk]leverig\.eu.+\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\?+\) \[\d+\/\d+\][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //PNG170514XW042SOE9[01/35] - "PNG170514XW042SOE9.jpg" yEnc
		if (preg_match('/^[\w.,& ()\[\]\'\`-]{8,}?\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
	...
	public function etc()
	{
		...
		if (preg_match('/^.+\[DoAsYouLike\].+\d+[.,]\d+ [kKmMgG][bB].+"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '    (\d+[.,])?\d+ ([kKmMgG])?[bB][- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+Old but Sold.+>< "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' >< \d+\/\d+ \(\d+[.,]\d+ [kKmMgG][bB]\).+ yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\d+[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function ftn()
	{
		...
		if (preg_match('/^(Usenet collector)?\(aangemeld.+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
	...
	public function games()
	{
		...
		if (preg_match('/\.net <<<Partner von SSL-News\.info>>> - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\)( - Description)?[-_ ]{0,5}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '( - \d+([.,]\d+ [kKmMgG])?[bB])? - \d+([.,]\d+ [kKmMgG])?[bB][-_ ]{0,3}(\[REPOST\] )?yEnc$/', $this->subject, $match)) {
			return $match[2];
	...
	public function games_dox()
	{
		...
		if (preg_match('/^\[NEW DOX\][ _-]{0,3}(.+?)[ _-]{0,3}\[\d+\/\d+\][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[NEW DOX] Minecraft.1.6.2.Installer.Updated.Server.List  - "Minecraft 1 6 2 Cracked Installer Updater Serverlist.nfo" - yEnc
		if (preg_match('/^\[NEW DOX\][ _-]{0,3}(.+?)[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[OLD DOX\][ _-]{0,3}\(\d+\/\d+\)[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[-_ ]{0,3}\d+[,.]\d+ [mMkKgG][bB][-_ ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function hdtv()
	{
		...
		if (preg_match('/\(Newseros\.com\) .+? \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+S\d+E\d+.+\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[ TrollHD \] - [\(\[] \d+\/\d+ [\)\]] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[00245] [ PPKORE ] [44/57] - "The L Word S04E08 1080p WEB-DL DD5 1 H 264-PPKORE.vol014+14.par2" yEnc
		if (preg_match('/\[\d+\][- ]{0,3}\[ PPKORE \][- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Adobe Photoshop Lightroom v5.2 - FiNaL - Multilingual [WIN].vol037+32.PAR2  yEnc
		if (preg_match('/^(.+?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4}) {0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[\w-\. ]+\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //"8 Wenn ich einmal gross bin .mp3" Koelschefetz postet.Die Filue -Immer Wigger  yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function hdtv_x264()
	{
		...
		if (preg_match('/^(AMEa)?\(\d+\/\d+\)( - AME-)? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d+[,.]\d+ [mMkKgG][bB] - yEnc$/', $this->subject, $match)) {
			return $match[3];
		}
		...
		if (preg_match('/^[A-Z][a-zA-Z0-9 ]+ [- ] "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function highspeed()
	{
		...
		if (preg_match('/^www\..+? \[Sponsored.+?\] \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[ .+? \] \[ www\..+? \]( \[.+?\])? \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
	...
	public function inner_sanctum()
	{
		...
		if (preg_match('/^\(\d+\/\d+\)( - Description -)? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '( - \d+[,.]\d+ [mMkKgG][bB])? - \d+[,.]\d+ [mMkKgG][bB] - yEnc$/', $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^[a-zA-Z0-9._-]+ \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match) && !preg_match('/[a-fA-F0-9]{32}/', $this->subject)) {
			return $match[1];
		}
...
//		}
	...
	public function mom()
	{
		...
		if (preg_match('/^\[Art-of-Usenet\] ([a-fA-F0-9]+) \[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		} //(????) [03/20] - "Weblinger - The.Haunted.House.Mysteries.v1.0-ZEKE.part01.rar" yEnc
		if (preg_match('/^\(\?+\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/[\w.-]{8,}[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[Art-of-Usenet] dea75eb65e65c56197d749d57919806d [01/19] - "dea75eb65e65c56197d749d57919806d.par2" yEnc
		if (preg_match('/^\[Art-of-Usenet\] .+? \[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //<ghost-of-usenet.org>XCOM.Enemy.Unknown.Deutsch.Patch.TokZic [0/9] - "XCOM Deutsch.nzb" ein CrazyUpp yEnc
		if (preg_match('/^<ghost-of-usenet\.org>(.+?) \[\d+\/\d+\] - ".+?" .+? yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/(\d+\))[ _-]{0,3}Description[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/i', $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/brothers-of-usenet\.info&net-empfehlen-ssl-news.+\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Eragon postet   Pfeil   S01E18   german                      [01/19] - "Pfeil S01E18.par2" yEnc
		if (preg_match('/^Eragon postet.+\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^- (Description - )?"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[2];
		} //::: Usejunkies.tk ::: - [11/15] - "Saitenfeuer - Kein Zurueck 2013.vol00+1.par2" - 116,42 MB yEnc
		if (preg_match('/^.+Usejunkies\.tk.+\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //:.Usejunkies.tk.:---- - [4/8] - "MKTO - MKTO.vol00+5.par2" yEnc
		if (preg_match('/^.+Usejunkies\.tk.+\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\) \[ArtofUsenet\].+www\.art-of-use\.net.+"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(1/3) "Die drei Fragezeichen - Folge 162 - Der schreiende Nebel.rar" - 121,56 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\)([- ]{0,3}[\w\s*.-]+)?[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[2];
		} //(002/393) - "1yD8uW8ueG.part1.rar" - yEnc
		if (preg_match('/^\(\d+\/\d+\)([- ]{0,3}[\w\s*.-]+)?[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\(\d+\/\d+\)[- ]{0,3}[|][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}[|] yEnc$/u', $this->subject, $match)) {
			return $match[1];
		} //(6d402XsX405bAwWa387HHe40JJ2) "6d402XsX405bAwWa387HHe40JJ2.part19.rar" yEnc
		if (preg_match('/^\(\w+\)[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(Die Forsyte Saga--E17-XviD) [17/26] - "17 Der weiÃe Affe.part16.rar" yEnc
		if (preg_match('/^\([\w\s-]+\)[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Harry.Potter.and.the.Prisoner.of.Azkaban.1080p.h264 - "Harry.Potter.and.the.Prisoner.of.Azkaban.1080p.h264.part116.rar" yEnc
		if (preg_match('/^[\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Caro Emerald[20/20] - "Caro Emerald In Concert UNTOUCHED.vol189+21.par2" yEnc
		if (preg_match('/^[\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[32/32]  The Band - Live at the Academy Of Music 1971 (DVD) "The Band - Live at the Academy Of Music 1971 (DVD).vol135+129.PAR2" yEnc
		if (preg_match('/^\[\d+\/\d+\][- ]{0,3}[\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Game Of Thrones S03E01 FRENCH [HDTV-Rip] - jo post "senorht fo emag 301.par2" 607,30 MB yEnc
		if (preg_match('/^([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}) - jo post[- ]{0,3}"[\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //brothers-of-usenet.info/.net <<<Partner von SSL-News.info>>> - [01/19] - "Age.of.Dinosaurs.German.AC3.HDRip.x264-FuN.par2" yEnc
		//>>>>>Hell-of-Usenet.org>>>>> - [01/35] - "Female.Agents.German.2008.AC3.DVDRip.XviD.iNTERNAL-VideoStar.par2" yEnc
		if (preg_match('/^.+?\.(info|org)>+ - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
	...
	public function moovee()
	{
		...
		if (preg_match('/^\[x+\]-\[.+?\]-\[ x+ \]-\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
	...
	public function movies()
	{
		...
		if (preg_match('/^\(\d+\/\d+\)[-_ ]{0,3}Description[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^- Description - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '([- ]{0,3}\d+[.,]\d+ [kKmMgG][bB])[- ]{0,4}yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function movies_divx()
	{
		...
		if (preg_match('/^\(www\.Thunder-News\.org\) .+? - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Movieland Post Voor FTN - [01/43] - "movieland0560.par2" yEnc
		if (preg_match('/^[a-zA-Z ]+Post Voor FTN - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Disney short films collection by mayhem masta"1923 - Alice's Wonderland.vol15+7.par2" yEnc
		if (preg_match('/.+?by mayhem masta"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function movies_x264()
	{
		...
		if (preg_match('/^\([\w.-]+\)[\(\[]\d+\/\d+[\]\)] "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^< [\w.() -]+ > - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \(\d+\/\d+\) yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \d+ of \d+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function mp3()
	{
		...
		if (preg_match('/^.+Usejunkies\.tk.+[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //"AnyDVD 7.0.0.0.rar" poc  yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}poc[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //"A Produce & Loren Nerell - Intangible.nzb" yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(01/12) "Sunfly Hits April (2013) SF326 [Skytwohigh].par2" - 109.59 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\)[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(01/15) - Description - "Goldene Schlager - Erinnerungen Folge 3.par2" - 126,08 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\)[- ]{0,3}Description[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(Musica - House&Dance - mix 1 - april 2014 1) [00/45] - "Musica - House&Dance mix 1 april.nzb" yEnc
		if (preg_match('/^\(([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\) \[\d+\/\d+\][- ]{0,3}".+?' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar|\.7z)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4}) [\w.,& ()\[\]\'\`-]{8,}?\b.?( by )?PsyDealer  yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\?+\)[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(????) [00/34] - "The Official UK Top 40 Singles Chart 15-06-2014.nzb"otfINWnjfg7856fghj  yEnc
		if (preg_match('/^\(\?+\)[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '\w+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(102400\) \[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\([\w.,& ()\[\]\'\`-]{8,} - by Taekwondo(\d+\()?\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+[.,]\d+ [kKmMgG][bB] <-> Partner of secretusenet\.com <->[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //Yogi_and_Husky--Nu_Sound_EP-(RSR021)-WEB-2012-dh - "Yogi_and_Husky--Nu_Sound_EP-(RSR021)-WEB-2012-dh.r00" yEnc
		if (preg_match('/^[\w.,& ()\[\]\'\`-]{8,}?[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Zido.Alben.All.in.One.Read.NFO-Ren & Stimpy - [35/43] - "Zydo.part33.rar" yEnc
		if (preg_match('/^([\w.,& ()\[\]\'\`-]{8,}?)[- ]{0,3}\[\d+\/\d+\][- ]{0,3}".+?' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //! ! !! - h311b0y101022014 - !! ! ! [01/14] - "h311b0y101022014.par2" yEnc
		if (preg_match('/(h311b0y|Hellboy).+\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function mp3_complete_cd()
	{
		...
		if (preg_match('/^\(\d+\/\d+\)[ _-]{0,3}\[Lords-of-usenet\][ _-]{0,3}<<Partner of SSL-News.info>>[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //(06/11) - <www.lords-of-usenet.org><by Nerts> - "Diens - Schwarzmale.vol00+01.PAR2" - 141,07 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\)[ _-]{0,3}<www\.lords-of-usenet\.org><by Nerts>[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //<www.Lords-Of-Usenet.org><by Nerts> (09/18) - "Mantus - Fatum (2013) [2CD].FH.vol00+2.PAR2" - 336,39 MB - yEnc
		if (preg_match('/^<www\.lords-of-usenet\.org><by Nerts>[ _-]{0,3}\(\d+\/\d+\)[ _-]{0,3}[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //(08/15) "Noemi-Red.(Unreleased).2006.by.NYCrules.vol000+01.PAR2" - 179,66 MB - yEnc
		if (preg_match('/^\(\d+\/\d+\)[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/i', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^\[([a-zA-Z0-9-_\(\)\.]+)\] \[www\.usenet4ever\.info by Secretusenet\] -  "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^>ghost-of-usenet\.org<< ([a-zA-Z0-9-_\(\)\.]+) >>www\.SSL-News\.info> -  "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^\[\d+\/\d+\] - \((MP3 )?ALBUM CHARTS\) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/i', $this->subject, $match)) {
			return $match[2];
		} //"Miley Cyrus - Bangerz (Deluxe Version).nzb" - yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //VA 200 NRJ 2014 CD2 mp3_320kbps[18/27]VA 200 NRJ 2014 CD2 mp3_320kbps"(217) [Capital Cities] Safe And Sound.mp3"  yEnc
		if (preg_match('/^.+\[\d+\/\d+\](.+)"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function mp3_full_albums()
	{
		...
		if (preg_match('/^\(\d+\/(\d+\)) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,4}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}.+?yEnc$/', $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\[\d+\]-\["([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '\[ yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\d+ "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function multimedia()
	{
		...
		if (preg_match('/^([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)\.[A-Za-z0-9]{2,4} - \[\d+\/(\d+\])  yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function multimedia_documentaries()
	{
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \[\d+ of \d+ - \d+ [kKmMgG][bB]\] yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function multimedia_scifi()
	{
		...
		if (preg_match('/^some m4vs - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function music()
	{
		...
		if (preg_match('/^.+By Dready Niek \) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+ghost-of-usenet\.org.+"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '> >www\.SSL-News\.info<  - \(\d+\/\d+\) - \d+[.,]\d+ [kKmMgG][bB] yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //Musikjunkie-The.Voice.Of.Germany.2013.The.Best.of.Liveshows.4.CD.Box.Set.VBR [15/28]"voice.part13.rar" yEnc
		...
		if (preg_match('/^.+\(by dem verrÃ¼ckten Lordi\)[- ]{0,3}\(\d+\/\d+\)[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+[.,]\d+ [kKmMgG][bB].+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^\(\d+\/\d+\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+[.,]\d+ [kKmMgG][bB][- ]{0,3}.+yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^.+ \[\d+ of \d+\] "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Wendy O Williams Bump n Grind - "Wendy.O.Williams.Bump.n.Grind.nfo"  yEnc
		if (preg_match('/^.+[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar|\.7z)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4}) \d+\/\d+[- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[\w. &()\[\]\'-]+?\.- ([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar|\.7z)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4}) \[\d+\/\d+\][- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function music_mp3()
	{
		...
		if (preg_match('/^\[\d+\/\d+\][ -]{0,3}\(((Top)?\d+ )?(MP3 )?((Album|Single) )?Charts\)[ -]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/', $this->subject, $match)) {
			return $match[6];
		}
		...
		if (preg_match('/^\[\d+\/\d+\][ -]{0,3}(Album )?Top \d+( Album Charts \d+)?[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/', $this->subject, $match)) {
			return $match[3];
		}
		//[1/1] (Album Top 100 - 2012) - "Cro - Einmal Um Die Welt.rar"  yEnc
		//[1/1] (Album Top 100 2012) - "Cro - Einmal Um Die Welt.rar"  yEnc
		//[1/1] (Album Top 100) - "Cro - Raop.rar"  yEnc
		if (preg_match('/^\[\d+\/\d+\][ -]{0,3}\(Album Top \d+(( -)? \d+)?\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/', $this->subject, $match)) {
			return $match[3];
		...
		if (preg_match('/^[\(\[]\d+\/\d+[\]\)][ -]{0,3}\(MP3 Album\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+usenet-piraten\.info.+[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //[1/8] - "Nightwish - Storytime (Retail-Single 2011).sfv" -  ShapterV yEnc
		if (preg_match('/^\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,4}ShapterV yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //100 Rock - Vol.04<>usenet-piraten.info<>www.newsconnection.eu<> - (1/5)  "100 Rock - Vol.04.par2" - 101,65 MB - yEnc
		if (preg_match('/^.+usenet-piraten\.info.+newsconnection\.eu.+[- ]{0,3}\(\d+\/\d+\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
	...
	public function ps3()
	{
		...
		if (preg_match('/^(\[\d+\] )\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1] . $match[2];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function sound_mp3()
	{
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}\(\d+\/(\d+\))[ _-]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //trtk09920 - [01/12] - "Guido Negraszus - Night Cafe Iii (Freedom Travellers) (2012)(320).par2" yEnc
		if (preg_match('/^trtk\d+[ -]{0,3}\[\d+\/\d+\][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //(????) [001/153] - "C4 House Party Horse Meat Disco Set 6.nfo" C4 House Party Horse Meat Disco Set 6 yEnc
		if (preg_match('/^\(\?+\) \[\d+\/\d+\][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[\d+\/\d+\][ -]{0,3}Top \d+ Album Charts \d+[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' {1,4}yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //<>usenet-piraten.info<>partner<>ssl-news.info<> - [10/10] - "Overexposed (Deluxe Version).vol31+23.par2" yEnc
		if (preg_match('/^.+usenet-piraten\.info.+ - \[\d+\/\d+\][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\) - VERBAteamÂ present - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //[1/1] - (Album Top 1000) - "Davis, Miles - Complete Live at the Plugged Nickel 1965.rar"  yEnc
		if (preg_match('/^\[\d+\/\d+\][ -]{0,3}\(Album Top \d+\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '  yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function sounds_lossless()
	{
		...
		if (preg_match('/^http:\/\/dream-of-usenet\.org .+? - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^trtk\d+ - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.:[-_ ]{0,3}(.+?)[-_ ]{0,3}:..+?thunder-news\.org.+?secretusenet\.com:. - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //_ "CARUSO & GIGLI - O Sole Mio - The  Unknown.nzb" yEnc
		if (preg_match('/^[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		}
		...
		if (preg_match('/^[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[-_ ]{0,3}\d+ (of \d+)( \(\d+\/\d+\)){1,2} (yEnc)?$/', $this->subject, $match)) {
			return $match[1];
		} //"Doc Watson - 1973 - The Essential Doc Watson - 01 - Tom Dooley.flac" - 406.64 MB - yEnc
		if (preg_match('/^[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[ _-]{0,3}\d+[.,]\d+ [kKmMgG][bB][ _-]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function sounds_mp3()
	{
		...
		if (preg_match('/^\(dream-of-usenet\.info\) - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //http://dream-of-usenet.org empfehlen newsconnection.eu - [02/32] - "Adam_Ant-Manners_and_Physique-(MCAD-6315)-CD-FLAC-1989-2Eleven.par2" yEnc
		if (preg_match('/^http:\/\/dream-of-usenet\.org .+? - \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+?usenet-space.+?Powered by.+? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+? \d+\/\d+ \(\d+[.,]\d+ [kKmMgG][bB]\) .+? \d+[.,]\d+ [kKmMgG][bB] .+?yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //"The Absence - Riders Of The Plague" [00/14] - "the_absence-riders_of_the_plague.nzb" yEnc
		if (preg_match('/"(.+)"[-_ ]{0,3}[\(\[]\d+\/(\d+[\)\]])[-_ ]{0,3}".+(\.part\d*|\.rar)?(\.vol.+ \(\d+\/\d+\) "|\.[A-Za-z0-9]{2,4}").+?yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+usenetrevolution.+Partner of ssl-news\.info.+\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //<<<Old but Sold>>>  <<< >< >< "German Top 50 ODC - 12.08.2013.nfo" >< 02/33 (541,61 MB) >< 10,93 kB > yEnc
		if (preg_match('/^.+Old but Sold.+>< "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' >< \d+\/\d+ \(\d+[.,]\d+ [kKmMgG][bB]\).+ yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+ghost-of-usenet.org[<>] [><]"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '> >www\.SSL-News\.info<  - \(\d+\/\d+\)[- ]{0,3}\d+[.,]\d+ [kKmMgG][bB][- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //BY REQ:........! - "Keith Whitley - All American Country - .par2" [06/22]  yEnc
		if (preg_match('/^BY REQ.+ - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \[\d+\/\d+\]  yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //Der etwas andere Mix - Wilde Herzenmix (auf wunsch) neu (by dem verrÃ¼ckten Lordi) (1/8) "Der etwas andere Mix - Wilde Herzenmix.par2" yEnc
		if (preg_match('/^Der etwas.+ \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/i', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+[\[\(]\d+\/\d+[\)\]][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //"8 Wenn ich einmal gross bin .mp3" Koelschefetz postet.Die Filue -Immer Wigger  yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '.+yEnc$/', $this->subject, $match)) {
			return $match[1];
	...
	public function sounds_mp3_complete_cd()
	{
		...
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . 'by_Funkeefly yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //trtk09920 - [01/12] - "Guido Negraszus - Night Cafe Iii (Freedom Travellers) (2012)(320).par2" yEnc
		if (preg_match('/^trtk\d+[ -]{0,3}\[\d+\/\d+\][ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^<<<usenet-space-cowboys\.info>>>.+secretusenet\.com> < "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' >< \d+\/\d+ \(\d+[.,]\d+ [kKmMgG][bB]\) >< \d+[.,]\d+ [kKmMgG][bB] > yEnc$/i', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^>>> www.lords-of-usenet\.org <<< "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[-_ ]{0,3}\[\d+\/\d+\] - (\[)?\d+[.,]\d+ [kKmMgG][bB](\])? yEnc$/i', $this->subject, $match)) {
			return $match[1];
	...
	public function sounds_mp3_electronic()
	{
		...
		if (preg_match('/^\(\d+\/\d+\)[ -]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+ [bB][- ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^Selected Songs by Various Artists - ([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)([-_](proof|sample|thumbs?))*(\.part\d*(\.rar)?|\.rar|\.7z)?(\d{1,3}\.rev|\.vol.+?|\.[A-Za-z0-9]{2,4})[ -]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
	...
	public function teevee()
	{
		...
		if (preg_match('/^\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' - \d.+?B - (\d.+?B -)? yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(Dgpc\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(bf1\) \[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\([\w. -]{8,}\)[-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}""([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '"[-_ ]{0,3}[\w. -]+[-_ ]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[[\w. -]{8,}\][-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[\]-\[FULL\]-\[a\.b\.teevee\]-\[[\w.-]+\][-_ ]{0,3}\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\(\d+\/\d+\)[-_ ]{0,3}[\w. -]+[-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[ [A-Za-z]+ \] - (\[\d+\/\d+\] - )?"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\(www\..+?\) .+? <Sponsored.+?> - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/\.info .+?Powered by .+?\.com "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' .+? \d+\/\d+ \(\d+[,.]\d+ [mMkKgG][bB]\) .+? yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/[Ss]\d+[Ee]\d+.+\[\d+ of \d+\] "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Sam & Cat - S01E10 - BabysittingCommercial - "Sam & Cat - S01E10 - BabysittingCommercial.m4v" yEnc
		if (preg_match('/[Ss]\d+[Ee]\d+.+- "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^For teevee - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . ' \[\d+\/\d+\][ _-]{0,3}yEnc$/', $this->subject, $match)) {
			return $match[1];
		} //"Mad.Men.S06E11.HDTV.x264-2HD.par2" yEnc
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^.+EnJoY\!.+\[\d+\/\d+\][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //The.Colbert.Report.2013.07.29.The.Lumineers.WEBRip.AAC2.0.H.264-DCK [01/11] - "The.Colbert.Report.2013.07.29.The.Lumineers.WEBRip.AAC2.0.H.264-DCK.mp4"  yEnc
		if (preg_match('/^[\w. -]+\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //the.lockerbie.bombing.720p.HDTV.x264-fatboy  - "the.lockerbie.bombing.720p.HDTV.x264-fatboy.nfo" - 829.12 MB - yEnc
		if (preg_match('/^[\w. -]+[-_ ]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //The.Vampire.Diaries.S05E13.HDTV.X264"The.Vampire.Diaries.S05E13.HDTV.X264.vol40+36.PAR2" yEnc
		if (preg_match('/^[\w. -]+[-_ ]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[[\w.-]+\][-_ ]{0,3}.+[-_ ]{0,3}\(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[[\w. -]+\][-_ ]{0,3}.+[-_ ]{0,3}[\[\(]\d+\/\d+[\]\)][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		} //Dave Gorman Modern Life is Goodish Series 1 - [114 of 126] - "Dave Gorman Modern Life is Goodish S01E06.mkv.008" yEnc
		if (preg_match('/^[\w -]+[-_ ]{0,3}[\[\(]\d+ of \d+[\]\)][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[ \d+[.,]\d+ [kKmMgG][bB] \][-_ ]{0,3}\[ \d+\/\d+ \][-_ ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[\w. ()-]{8,}?\b\(\d+\/\d+\)[- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
	...
	public function tv()
	{
		...
		if (preg_match('/^[\[\(]\w+[\]\)][- ]{0,3}\[\d+\/\d+\] - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^"[\w ]+" yEnc[- ]{0,3}\[\d+\/\d+\][- ]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
	...
	public function tvseries()
	{
		...
		if (preg_match('/^"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '( - \d+([.,]\d+ [kKmMgG])?[bB])? - \d+([.,]\d+ [kKmMgG])?[bB] - yEnc$/', $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^[a-zA-Z0-9 -_\.]+ \[\d+\/(\d+\]) - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
	...
	public function usenetrevolution()
	{
		...
		if (preg_match('/^\[\d+\/\d+\][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e0 . '[- ]{0,3}\d+[.,]\d+ [kKmMgG][bB].+secretusenet\.com.+yEnc$/i', $this->subject, $match)) {
			return $match[1];
		}
	...
	public function worms()
	{
		...
		if (preg_match('/^\(\d+\/\d+\) - Description - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
	...
	public function generic_town()
	{
		...
		if (preg_match('/^<TOWN>.+?town\.ag.+?(www\..+?|News)\.[iI]nfo.+? \[\d+\/\d+\]( -)? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[3];
		...
		if (preg_match('/^<TOWN>.+?town\.ag.+?(www\..+?|News)\.[iI]nfo.+? \[\d+\/\d+\]( -)? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[3];
		} //(05/10) -<TOWN><www.town.ag > <partner of www.ssl-news.info > - "D.Olivier.Wer Boeses.saet-gsx-.part4.rar" - 741,51 kB - yEnc
		if (preg_match('/^\(\d+\/\d+\) -<TOWN><www\.town\.ag >\s+<partner.+> - "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[2];
		} //[ TOWN ]-[ www.town.ag ]-[ partner of www.ssl-news.info ]-[ MOVIE ] [14/19] - "Night.Vision.2011.DVDRip.x264-IGUANA.part12.rar" - 660,80 MB yEnc
		if (preg_match('/^\[ TOWN \][ _-]{0,3}\[ www\.town\.ag \][ _-]{0,3}\[ partner of www\.ssl-news\.info \][ _-]{0,3}\[ .* \] \[\d+\/\d+\][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^\[ TOWN \][ _-]{0,3}\[ www\.town\.ag \][ _-]{0,3}\[ partner of www\.ssl-news\.info \][ _-]{0,3}(\[ TV \] )?\[\d+\/\d+\][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^[ <\[]{0,2}TOWN[ >\]]{0,2}[ _-]{0,3}[ <\[]{0,2}www\.town\.ag[ >\]]{0,2}[ _-]{0,3}[ <\[]{0,2}partner of www.ssl-news\.info[ >\]]{0,2}[ _-]{0,3}\[\d+\/\d+\][ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //<TOWN> www.town.ag > sponsored by www.ssl-news.info > (1/3) "HolzWerken_40.par2" - 43,89 MB - yEnc
		if (preg_match('/^<TOWN> www\.town\.ag > sponsored by www\.ssl-news\.info > \(\d+\/\d+\) "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[1];
		} //(1/9)<<<www.town.ag>>> sponsored by ssl-news.info<<<[HorribleSubs]_AIURA_-_01_[480p].mkv "[HorribleSubs]_AIURA_-_01_[480p].par2" yEnc
		if (preg_match('/^\(\d+\/\d+\).+?www\.town\.ag.+?sponsored by (www\.)?ssl-news\.info<+?.+? "([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		...
		if (preg_match('/^\[ TOWN \][ _-]{0,3}\[ www\.town\.ag \][ _-]{0,3}\[ (.+?) \][ _-]{0,3}\[ partner of www\.ssl-news\.info \][ _-]{0,3}\[\d+\/(\d+\])[ _-]{0,3}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[1];
		...
		if (preg_match('/^<TOWN><www\.town\.ag > <partner of www\.ssl-news\.info > (.+) \[\d+\/\d+\][ _-]{0,3}("|#34;).+?("|#34;).+?yEnc$/i', $this->subject, $match)) {
			return $match[1];
		} //[ TOWN ]-[ www.town.ag ]-[ partner of www.ssl-news.info ]-[ XBOX360 ] - [017/167] - "Fable.2.GOTY.GERMAN.RF.XBOX360-JJ.part016.rar" - 8.05 GB yEnc
		if (preg_match('/^\[ TOWN \][ _-]{0,3}\[ www\.town\.ag \][ _-]{0,3}\[ partner of www\.ssl-news\.info \][ _-]{0,3}\[ .+ \][ _-]{0,3}\[\d+\/(\d+\])[ _-]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e2, $this->subject, $match)) {
			return $match[2];
		} //[ TOWN ]-[ www.town.ag ]-[ partner of www.ssl-news.info ]-[ 1080p ] - [110/132] - "3N2auNHdmj9QJvEvuapys87KT.part109.rar" yEnc
		if (preg_match('/^\[ TOWN \][ _-]{0,3}\[ www\.town\.ag \][ _-]{0,3}\[ partner of www\.ssl-news\.info \][ _-]{0,3}\[ .+ \][ _-]{0,3}\[\d+\/(\d+\])[ _-]{0,4}"([\w\säöüÄÖÜ¤ß¶!.,&_()\[\]\'\`-]{8,}?\b.?)' . $this->e1, $this->subject, $match)) {
			return $match[2];
		}
		return array("cleansubject" => $this->releaseCleanerHelper($this->subject), "properlynamed" => false);
	}
